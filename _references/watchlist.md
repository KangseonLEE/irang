...
## 2. Kill Criteria 날짜 (Sprint1 실행플랜) — 판정 종료

> Scenario A(4/17 일 UV<5)·B(5/3 WAU<20) 모두 판정 완료, Kill 미발동(5/3 WAU 55명). 2026-08-18 회장 결재로 감시 항목 삭제. 새 게이트 일정 발생 시 여기 재정의.
