...
const CORRECTIONS: CorrectionEntry[] = [
  {
    date: "2026-05-16",
    field: "추천 카드 의견 받기 신설 — ‘도움이 됐어요 / 다른 결과를 보고 싶어요’",
    description:
      "진단 결과 화면(/match, /assess 결과)에서 보여드리는 페르소나 추천 카드(작물·지원사업) 아래에 ‘이 추천 어땠어요?’ 한 줄을 추가했어요. ‘도움이 됐어요(👍)’ 또는 ‘다른 결과를 보고 싶어요(👎)’ 두 가지로 의견을 표시하실 수 있고, 같은 버튼을 다시 누르면 표시가 취소돼요. 4~6주 동안 의견이 충분히 쌓이면(50건 이상) 페르소나별로 어떤 추천이 잘 맞고 어떤 추천이 어색한지 살펴보고, 추천 순서를 더 자연스럽게 다듬는 데 쓸 예정이에요. 모든 의견은 익명으로 기록되고, 개인을 식별할 수 있는 정보는 받지 않아요.",
  },
  {
    date: "2026-05-14",
