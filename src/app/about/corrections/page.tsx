...
const CORRECTIONS: CorrectionEntry[] = [
  {
    date: "2026-05-18",
    field: "귀농인 인터뷰 mountain·healing 카테고리 보강 (5건 신규)",
    description:
  ...
  },
  {
    ...
    description:
      "/regions/ranking 화면을 두 번에 걸쳐 손봤어요. 먼저 결과 카드 안의 칩(라벨 배지)을 5개에서 1~2개로 줄이고, 카드를 누르면 시군구의 핵심 정보 5종(주요 작물·인구 밀도·활성 사업·D-7 마감·강점/약점)이 한 화면에 모이는 상세 모달이 열리도록 했어요. 그다음 진입 흐름도 다듬어서, 처음 들어오신 분에게 ‘귀농 스타일 맞춤(1분)·차원별 보기(30초)·맞춤 가중치(3분)’ 세 가지 모드 중 하나를 고르고, 세부 옵션을 정한 다음, 마지막으로 시도 17곳 중 한 곳을 좁히거나 ‘전체’로 보는 3단계 wizard를 보여드려요. 결과 화면 상단에는 ‘지금 보고 있는 모드’와 ‘다른 모드로 바꾸기·다시 선택’ 칩이 항상 떠 있어서 한 번의 결정으로 다른 비교 방식으로 전환할 수 있고, 기존에 결과 하단에 있던 큰 ‘처음부터 다시’ 카드는 상단 칩으로 통합돼 정리됐어요. 시도 필터·가중치 슬라이더·근거 펼침·1~3위 메달 색상·시군구 deep link는 그대로 유지돼요.",
  },
  {
    date: "2026-05-14",
    field: "시군구 점수 비교 화면 진입 wizard 신설 (C안 D1~D5)",
    description:
      "/regions/ranking 화면을 처음 여신 분에게 ‘어떤 기준으로 비교하시겠어요?’를 묻고, 두 단계만에 추천 시군구 30곳을 보여드리는 wizard 형태로 정돈했어요. 1단계에서 ‘귀농 스타일 맞춤’ 또는 ‘차원별 1위’ 모드를 고르고, 2단계에서 스타일(5종) 혹은 차원(5종)을 고르면 곧바로 ranking이 켜져요. 1~3위에는 금·은·동 색상으로 시각적 무게를 살짝 다르게 줘서 한눈에 들어오도록 했고, 시도 필터·가중치 슬라이더·근거 펼침은 기존 그대로 유지돼요. 카드 진입 흐름이 분석 도구(start → step → complete)에 기록돼 다음 한 주 동안 어느 경로가 잘 쓰이는지 확인할 수 있어요. 카드 위에는 모드 토글(스타일/차원/직접)이 정리돼 있어서 wizard 없이 바로 모드만 바꿔도 같은 결과를 보실 수 있어요.",
  },
  {
    date: "2026-05-14",
