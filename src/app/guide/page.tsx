...
export const metadata: Metadata = {
  title: "농촌 정착 절차 5단계 — 준비부터 정착까지 로드맵",
  description:
    "정착 준비부터 정착까지, 5단계 프로세스를 체크리스트와 함께 안내해요. 각 단계별 소요 기간, 핵심 과업, 예상 비용, 지원사업 정보를 확인하세요.",
  keywords: ["농촌 정착 절차", "정착 준비 순서", "정착 로드맵", "정착 단계", "농촌 정착 방법", "정착 준비 기간"],
...
const STEPS: GuideStep[] = [
  {
    ...
    details: [
      "정착 동기와 목표를 명확히 정리하세요 (농업 경영, 전원생활, 은퇴 후 안정 등).",
      ...
      "귀농 관련 커뮤니티(귀농귀촌종합센터, 지역 카페 등)에 가입하여 선배 정착자의 경험담을 수집하세요.",
    ],
    checklist: [
  ...
  },
  {
    ...
    period: "3~6개월",
    summary:
      "귀농 관련 교육을 100시간 이상 이수하는 단계예요. 대부분의 농촌 정착 지원사업이 교육 이수를 필수 자격 요건으로 요구해요.",
    details: [
      "귀농귀촌종합센터, 농업기술센터, 한국농수산대학 등에서 교육을 수강하세요.",
      "이론교육(온라인)과 실습교육(오프라인)을 균형 있게 이수하세요.",
      "정착 창업 교육(100시간)을 완료하면 농촌 정착지원금, 농지 임대 등 여러 지원사업 신청 자격이 생겨요.",
    ...
    tips: [
      "농림축산식품부 인증 교육만 이수 시간으로 인정돼요. 인증 여부를 반드시 확인하세요.",
      "체류형 귀농 교육은 실습 + 숙박이 포함되어 현지 생활을 미리 체험할 수 있어요.",
      "교육비의 일부 또는 전액을 지원하는 프로그램도 많으니 교육 페이지에서 확인하세요.",
    ],
    caution:
      "교육 이수 없이는 대부분의 농촌 정착 지원사업 신청이 어려워요. 이 단계를 건너뛰지 마세요.",
    links: [
  ...
  },
  {
    ...
    tips: [
      "시군구 상세 정보에서 의료기관 수, 학교 수, 인구 추이를 미리 확인할 수 있어요.",
      "선배 정착자의 실제 후기가 가장 신뢰도 높은 정보예요. 인터뷰 페이지를 참고하세요.",
  ...
  },
  {
    ...
    details: [
      ...
      "정착 창업 지원금, 농기계 임대, 시설 보조 등 지원사업을 신청하세요.",
    ...
    tips: [
      ...
      "대부분의 지원사업은 연초(1~3월) 또는 하반기(7~8월)에 공고돼요. 시기를 놓치지 마세요.",
    ...
    links: [
      ...
      { label: "농촌 정착 통계 보기", href: "/stats?tab=farming" },
    ],
  },
  {
    step: 5,
    ...
    tips: [
      ...
      "힘든 시기에 정착자 네트워크가 큰 힘이 돼요. 동기생·선배 정착자과의 관계를 유지하세요.",
    ],
    caution:
  ...
  return (
    <div className={s.page}>
      ...
      <section className={s.ctaSection}>
        <h2 className={s.ctaTitle}>맞춤 귀농 전략 찾기</h2>
