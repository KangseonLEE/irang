...
const STEPS: Step[] = [
  {
    ...
    items: [
      ...
      "온라인 정착 교육을 수강하며 기초 지식을 쌓으세요. 농림축산식품부 인증 교육이 이수 시간으로 인정돼요.",
  ...
  },
  {
    ...
    period: "2~4개월 전",
    items: [
      "시·도 농업기술센터에서 정착 창업 교육(100시간 이상)을 이수하세요. 대부분의 지원사업 신청에 필요해요.",
  ...
  },
  {
    ...
    items: [
      ...
      "지자체 정착 창업 지원금, 시설 보조, 농기계 임대 등 지원사업을 신청하세요.",
      "멘토링 프로그램에 참여하면 선배 정착자의 노하우를 직접 배울 수 있어요.",
    ...
    <article className={s.page}>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "정착 준비 순서", href: "/guides/preparation" },
        ]}
      />
      <JsonLd<HowTo>
        data={{
          ...
          "@type": "HowTo",
          name: "정착 준비 순서 — 5단계 체크리스트",
          description:
            "정보 수집부터 영농 시작까지, 정착 준비를 5단계로 정리했어요.",
          step: STEPS.map((step) => ({
            "@type": "HowToStep",
            name: step.title,
      ...
      <SubPageHero
        ...
        description="막막한 정착 준비, 단계별로 정리했어요."
      />
      ...
      <section className={s.cta}>
        <h2 className={s.ctaTitle}>맞춤 정착지 찾기</h2>
