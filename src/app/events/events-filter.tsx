...
/**
 * EventsFilter — /events 필터 wrap (데스크탑 그대로 + 모바일만 BottomSheet 전환).
 *
 ...
 *
 * 탭: 유형(EVENT_TYPES) · 지역(EVENT_REGIONS) 2종.
 * 날짜 필터(period)는 별도 컨트롤이 없어 BottomSheet 미포함.
 */
...
import s from "./events-filter.module.css";
