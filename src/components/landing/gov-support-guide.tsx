...
const GUIDES = [
  ...
  },
  {
    ...
    href: "/programs/roadmap?tab=forest-village",
    color: "#3a7c5f",
  ...
  },
  {
    ...
    tags: ["만 18~39세", "월 110만 원", "연 5,000명"],
    back: {
    ...
    href: "/programs/roadmap?tab=youth-startup",
    color: "#1a5c8a",
