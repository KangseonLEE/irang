...
export const PLAN_STEPS: PlanStep[] = [
  /* ── 1단계: 관심 및 정보 수집 ── */
  {
    ...
    icon: "🔍",
    description:
      "농촌 정착에 대한 막연한 관심을 구체적인 계획으로 전환하는 첫 단계예요. " +
      "자기 진단을 통해 귀농 적합성을 확인하고, 가족과 함께 방향을 설정해요. " +
      "이 단계에서 충분한 정보를 모을수록 이후 과정이 순탄해져요.",
    goal: "농촌 정착에 대한 기본 이해, 자기 진단, 가족 합의",
    checklist: [
      {
        id: "step1-item1",
        label: "귀농 적합성 자가 진단",
        description:
          "체력, 경제적 여건, 농촌 생활 적응력 등을 종합적으로 평가하여 본인의 정착 준비 수준을 파악해요.",
      ...
      },
      {
        ...
        label: "농촌 정착 정보 탐색",
        description:
          "귀농귀촌종합센터, 농업기술센터, 이랑 등에서 제공하는 다양한 농촌 정착 정보를 폭넓게 수집해요.",
      },
      {
        id: "step1-item3",
        label: "정착 유형 결정",
        description:
          "전업농, 반농반X(겸업), 주말농장 등 본인의 라이프스타일과 경제 상황에 맞는 정착 유형을 선택해요.",
        irangLink: "/match",
  ...
  /* ── 3단계: 지역 선정 ── */
  {
    ...
    checklist: [
      ...
      },
      {
        ...
        description:
          "선정한 시/도 내에서 읍/면/동 단위까지 세부적으로 탐색하여 최적의 정착 후보지를 좁혀 나가요.",
        irangLink: "/regions",
      ...
      {
        id: "step3-item4",
        label: "지역 주민 및 선배 정착자 면담",
        description:
          "해당 지역에 먼저 정착한 정착자나 지역 주민을 만나 실제 생활 여건과 주의사항을 청취해요.",
      },
      {
        id: "step3-item5",
        label: "지원사업 사전 조회",
        description:
          "해당 지역 지자체에서 운영하는 농촌 정착 지원사업(정착금, 주택지원, 영농자금)의 자격 요건과 일정을 사전에 확인해요.",
        irangLink: "/programs",
    ...
    checklist: [
      ...
      },
      {
        ...
        description:
          ...
          "귀농인의집은 최대 5년까지 임대 가능하며 지자체별 운영 현황이 달라요.",
      },
      {
        id: "step4-item6",
        label: "전입신고 (주민등록 이전)",
        description:
          ...
          "전입 시점이 정착자 인정 및 지원사업 자격의 기준일이 되므로 시기를 신중히 결정해요.",
      },
      {
        id: "step4-item7",
        label: "농업경영체 등록",
  ...
  /* ── 5단계: 영농 시작 ── */
  {
    ...
    description:
      "실질적으로 농사를 시작하는 단계예요. " +
      "농지원부 작성, 영농 계획 수립, 농기계·시설 확보 등 첫 해 영농에 필요한 기반을 갖춰요. " +
  ...
  /* ── 6단계: 정착 및 안정화 ── */
  {
    ...
    description:
      ...
      "지역 커뮤니티에 적극 참여하여 농촌 사회에 뿌리를 내려요.",
    ...
    checklist: [
      ...
      },
      {
        ...
        label: "커뮤니티 참여",
        description:
          "정착자 모임, 작목반, 마을공동체, 지역 봉사활동 등에 적극 참여하여 인적 네트워크를 확장하고 지역 사회에 안착해요.",
      },
      {
        id: "step6-item5",
        label: "농지원부 갱신",
