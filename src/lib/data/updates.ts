...
export const UPDATES: UpdateItem[] = [
  {
    ...
    summary:
      "지역 탐색·작물 정보·지역 비교·유형 진단·내 조건 순위·비용 가이드·지원사업·정착 로드맵, 여덟 가지로 가는 아이콘을 검색창 바로 아래에 두었어요. 준비하는 순서대로 늘어놓아 어디부터 볼지 고민이 줄고, 모바일에서는 옆으로 넘겨 볼 수 있어요. 대신 인터뷰 아래에 있던 '바로 시작하기' 묶음(진단 카드·시·군·구 검색·조건 카드)과 검색창 밑에서 저절로 흐르던 키워드 띠는 뺐어요. 검색창에 '가평'처럼 시·군·구 이름을 적으면 이미 그 지역으로 바로 가거든요.",
    href: "/",
    tag: "개선",
    media: {
      ...
      frame: "desktop",
      caption: "이전엔 검색창 아래로 키워드 띠가 흘렀고, 지금은 여덟 개 바로 가기 아이콘이 한 줄로 보여요",
    },
  },
  {
