    ...
    personas: [
      {
        ...
        description:
          "주말 농장이나 도시 농업 프로그램으로 귀농 적성을 먼저 테스트할 수 있어요.",
      },
      {
        title: "수도권 접근성을 유지하며 농업에 입문하려는 분",
        description:
          "서울 근교 직거래 시장 접근이 용이하고, 귀농 교육 기관이 풍부해요.",
      },
    ],
  },
  {
    ...
    personas: [
      {
        ...
        description:
          "강화도 순무·인삼, 옹진 해양 특산물 등 섬 농업 특화 작물을 재배할 수 있어요.",
      },
      {
        title: "수도권 접근성과 서해안 환경을 동시에 원하는 분",
        description:
          "서울 생활권이면서 강화·옹진 등 자연환경이 풍부한 농업 지역을 보유하고 있어요.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    personas: [
      ...
      },
      {
        ...
        description:
          "인구 밀도가 낮아 넓은 농지를 확보하기 쉽고, 관광과 연계한 팜스테이도 가능해요.",
      },
      {
        title: "겨울 스포츠·자연 레저를 즐기며 농업하려는 분",
        description:
          "사계절 뚜렷한 기후로 시즌별 다양한 여가 활동이 가능해요.",
      },
    ],
  },
  {
    ...
    personas: [
      {
        ...
        description:
          "세종시는 도심과 농촌이 공존하는 도농복합 도시로, 교육·의료·문화 인프라가 풍부해요.",
      },
      {
  ...
  },
  {
    ...
    personas: [
      ...
      },
      {
        ...
        description:
          "도시 인프라를 누리면서 인근 충남·충북 농지에서 영농을 시작할 수 있어요.",
      },
    ],
  },
  {
    ...
    personas: [
      ...
      },
      {
        ...
        description:
          "기초영농교육, 농지 장기 임대, 주택 융자 등 전국 단위 지원사업 접근이 용이해요.",
      },
    ],
  },
  {
    ...
    personas: [
      ...
      },
      {
        ...
        description:
          "전주 비빔밥 등 지역 식문화 브랜드와 연계한 로컬푸드 사업이 활발해요.",
      },
    ],
  },
  {
    ...
    personas: [
      {
        ...
        description:
          "광주에 거주하면서 인근 전남 지역 농지에서 영농 활동이 가능해요.",
      },
      {
    ...
    personas: [
      {
        ...
        description:
          "쌀, 고구마, 마늘, 양파, 배 등 다품목 재배가 가능하며, 보성 녹차 등 특산품도 유명해요.",
      },
      {
        title: "귀농 정착 지원금 등 실질적 혜택을 원하는 분",
        description:
          "순천시 귀농 정착 지원금, 주택 수리비 지원 등 전남 지역만의 파격적인 지원 혜택이 있어요.",
      },
      {
        title: "바다와 가까운 자연환경을 선호하는 분",
        description:
          "순천만, 보성 등 아름다운 남해안 생활환경과 농업을 동시에 누릴 수 있어요.",
      },
    ],
  },
  {
    ...
    personas: [
      ...
      },
      {
        ...
        description:
          "양산·김해 등 경남 농업지역과 인접해 있어, 도시 생활을 유지하며 영농 준비가 가능해요.",
      },
    ],
  },
  {
    ...
    personas: [
      {
        ...
        description:
          "대구 근교 과수원이 전통적으로 발달했고, 도시 소비자 직접 판매가 용이해요.",
      },
      {
  ...
  },
  {
    ...
    personas: [
      ...
      },
      {
        ...
        description:
          "울산 도심에서 30분 내 울주군 농촌에 접근 가능해, 단계적 귀농 준비에 적합해요.",
      },
    ],
  },
  {
    ...
    personas: [
      ...
      },
      {
        ...
        description:
          "마을 단위 귀농 정착 프로그램이 잘 갖춰져 있어 초기 적응이 수월해요.",
      },
    ],
  },
  {
    ...
    personas: [
      ...
      },
      {
        ...
        description:
          "지리산 산간 지역부터 남해안 온난 지역까지 다양한 생활환경을 선택할 수 있어요.",
      },
    ],
  },
  {
