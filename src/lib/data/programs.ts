...
const PROGRAMS_RAW: Omit<SupportProgram, "status">[] = [
  ...
  // ── 2026-09-26 3층: 잔여 9종 주산지 시군 특화 사업 8건(무는 현행 유효 사업 부재 — SP-062 가 덮음).
  //    시군 게시글·상설 안내(고정 URL), 매년 반복 근거(전년도 공고) 확인, CoS 원문 대조. 접수 시기는 상대 표기 → 9999 페어.
  //    함정: "무사마귀병"은 배추 병명이지 작물 '무'가 아니다. 태백 고랭지채소는 SP-062 의 시·군 창구라 미등재.
  {
    id: "SP-070",
    title: "당진시 고구마 무병묘 종순 공급 (바이러스 없는 종순, 시세 80%)",
    summary:
      "당진시 농업인이면 바이러스 없는 고구마 종순을 주당 120원에 받을 수 있어요. 해마다 4월 초 전화로 접수해요.",
    description:
      "고구마는 바이러스에 약해서 씨고구마가 병들면 수량이 크게 떨어져요. 당진시농업기술센터가 조직배양으로 키운 무병묘 종순을 국립식량과학원산 가격의 80%인 주당 120원에 나눠 줘요(보조금이 아니라 유상 공급이에요). 농업경영체를 등록한 당진시 농업인이면 농가당 1명, 100주에서 300주까지 신청할 수 있어요. 2026년은 4월 6일 오전 9시부터 계획량이 소진될 때까지 전화(041-360-6417~8)로 접수했고 종순은 5~6월에 받아요. 해마다 4월에 같은 안내가 올라오지만 품종이 바뀌니(2025년 소담미·2026년 호풍미) 그해 공고를 확인하세요.",
    region: "충청남도",
    organization: "당진시농업기술센터 농업기술과",
    supportType: "현물",
    supportAmount: "종순 주당 120원 유상공급(국립식량과학원산 가격의 80%), 농가당 100~300주",
    eligibilityAgeMin: 18,
    eligibilityAgeMax: 99,
    eligibilityDetail:
  ...
  {
    id: "SP-071",
    title: "진도군 겨울배추 동해방지 부직포 지원사업",
    summary:
      "진도에서 겨울배추를 키우면 동해 막는 부직포를 롤당 4만 원 중 절반만 내고 받을 수 있어요. 해마다 11월 초 공고예요.",
    description:
      "겨울배추는 한파를 맞으면 겉잎이 얼어 상품성이 크게 떨어져요. 진도군이 동해방지용 부직포 구입비의 절반을 군비로 대주는 사업이에요. 지원단가는 1롤 40,000원이고 0.1ha당 5롤을 기준으로 계산해요. 2025년 사업량 20ha·사업비 4,000만 원(군비 50%·자부담 50%) 규모라 조기 마감될 수 있어요. 신청일 기준 진도군에 주소를 두고 농업경영체를 등록한 겨울배추 재배 농업인이 읍·면사무소에 신청하고, 문의는 진도군 농업지원과예요. 2023·2024·2025년 세 해 연속 같은 사업이 공고됐어요.",
    region: "전라남도",
    organization: "진도군 농업지원과",
    supportType: "보조금",
    supportAmount: "부직포 40,000원/롤 중 군비 50% (0.1ha당 5롤 기준), 2025년 사업량 20ha",
    eligibilityAgeMin: 18,
    eligibilityAgeMax: 99,
    eligibilityDetail:
  ...
  {
    id: "SP-072",
    title: "고흥군 마늘·양파 흑색썩음균핵병 예방·토양선충 방제 지원",
    summary:
      "고흥에서 마늘·양파를 키우면 흑색썩음균핵병과 토양선충 방제 약제를 지원받을 수 있어요. 해마다 11~12월 접수예요.",
    description:
      "흑색썩음균핵병은 한번 퍼지면 포장을 갈아엎어야 할 만큼 피해가 큰 마늘·양파 토양병이에요. 고흥군이 병이 발생했거나 인접 포장이라 올해 발생이 우려되는 포장에 방제약제를 지원해요. 약제는 지역 실정에 맞게 공동 구입하고, 작목반이나 마을별로 방제단을 꾸려 함께 방제하면 효과가 커져요. 다만 전년산 마늘·양파 재배 경작신고를 하지 않은 농가는 제외되니, 갓 시작한 농가는 한 작기 경작신고 이력을 먼저 만들어야 해요. 신청은 사업장 소재지 읍·면사무소 산업팀이고 문의는 고흥군청 원예특작팀(061-830-5763)이에요. 2023년부터 4년 연속 공고됐어요.",
    region: "전라남도",
    organization: "고흥군 농업정책과 원예특작팀",
    supportType: "현물",
    supportAmount: "흑색썩음균핵병 예방·토양선충 방제약제 (공동 구입·공동방제 권장, 보조 비율은 시행지침 확인)",
    eligibilityAgeMin: 18,
    eligibilityAgeMax: 99,
    eligibilityDetail:
  ...
  {
    id: "SP-073",
    title: "합천군 양파·마늘 분야 지원사업 (종자대·농기계·톤백·건조기·토양개량제)",
    summary:
      "합천에서 양파·마늘을 키우면 종자대부터 농기계·톤백·건조기·토양개량제까지 5가지를 지원받을 수 있어요.",
    description:
      "합천군 농업기술센터가 양파·마늘 농가를 위해 운영하는 5개 묶음의 지원사업이에요. 고품질 양파 생산 종자대는 국내산·수입산 양파 종자 구입비를 정액으로 주고, 생력화 단지 조성은 정식기·파종기·수확기 같은 농기계를 지원해요. 연작장해 해소 토양개량제, 출하용 톤백(철제·철망), 흡입식 건조기 구입비도 각각 사업으로 있어요. 공고가 아닌 상설 안내라 만료가 없지만 지원단가와 신청 시기가 적혀 있지 않으니, 농업지도과 스마트원예담당(055-930-3975~3976)에 확인하세요. 개별 공고(2020년 토양개량제) 기준 사업대상은 '양파·마늘 재배하는 농업인 및 작목반, 생산자 단체 등'이라 개인 농가도 신청할 수 있어요.",
    region: "경상남도",
    organization: "합천군 농업기술센터 농업지도과",
    supportType: "보조금",
    supportAmount: "5개 사업 — 양파 종자대(정액), 생력화 농기계(정식기·파종기·수확기), 연작장해 토양개량제, 톤백, 흡입식 건조기. 단가는 사업별 공고 확인",
    eligibilityAgeMin: 18,
    eligibilityAgeMax: 99,
    eligibilityDetail:
  ...
  {
    id: "SP-074",
    title: "서산시 주요농산물 가격안정 지원사업 (대파·생강·들깨·참깨)",
    summary:
      "서산에서 대파나 생강을 키웠는데 값이 20% 넘게 떨어지면 차액의 80%를 300만 원까지 받을 수 있어요.",
    description:
      "수입 증가와 소비 감소로 밭작물 값이 급락할 때 농가 손실을 메워 주는 충남·서산 공동 사업이에요. 품목별 최근 5년 전국 도매시장 평균가격을 기준가격으로 삼고, 그해 주 출하기 평균가격이 기준가격보다 20% 이상 떨어지면 차액의 80%를 보전해 줘요. 지원 한도는 농가당 1품목·1기작에 300만 원이고 대상 면적은 10,000㎡(시설 5,000㎡) 이하예요. 2026년 대상품목은 대파, 생강, 들깨, 참깨, 가을쪽파 다섯 가지고, 파종 전후 출하약정을 맺은 뒤 농지 소재지 읍·면·동 행정복지센터에 신청해요. 신청 기간이 '각 품목 파종 전·후 1개월'이라 품목마다 달라지니 서산시 농업기술센터 농업정책과에 확인하세요.",
    region: "충청남도",
    organization: "서산시 농업기술센터 농업정책과",
    supportType: "보조금",
    supportAmount: "기준가격 대비 20% 이상 하락 시 차액의 80% 지원, 농가당 1품목·1기작 300만 원 한도 (대상면적 10,000㎡ 이하·시설 5,000㎡)",
    eligibilityAgeMin: 18,
    eligibilityAgeMax: 99,
    eligibilityDetail:
  ...
  {
    id: "SP-075",
    title: "진도군 신소득 특화작물 육성 지원사업 (생강·시금치)",
    summary:
      "진도에서 생강을 시작하면 종자와 자재를 ha당 720만 원 기준 70%까지 받을 수 있어요. 해마다 4월 접수예요.",
    description:
      "진도군이 소득을 새로 낼 수 있는 특화작물을 키우려고 종자·자재비를 대주는 사업이에요. 생강은 종자와 자재를 ha당 7,200천 원 기준으로 지원하고, 이 가운데 군비가 70%(5,040천 원)·자부담이 30%(2,160천 원)예요. 함께 묶인 품목은 고사리 종자, 치자 묘목, 쑥 영양제, 시금치 씨비닐이에요. 농업경영체를 등록한 진도군 농업인·농업법인·농협이 대상이고 재배 경력을 요구하지 않아서 갓 정착한 농가도 신청할 수 있어요. 다만 생강 사업량이 1ha뿐이라 조기 마감될 수 있으니, 주소지 읍·면사무소나 진도군 농업지원과(061-540-3522)에 미리 확인하세요.",
    region: "전라남도",
    organization: "진도군 농업지원과",
    supportType: "보조금",
    supportAmount: "생강(종자 및 자재) ha당 7,200천 원 — 군비 70%(5,040천 원)·자부담 30%, 사업량 1ha",
    eligibilityAgeMin: 18,
    eligibilityAgeMax: 99,
    eligibilityDetail:
  ...
  {
    id: "SP-076",
    title: "제주형 농산물 가격안정관리제 (당근·브로콜리)",
    summary:
      "제주에서 당근을 키우면 출하기 값이 기준보다 떨어질 때 차액의 90%를 보전받을 수 있어요. 자조금 가입·계약재배가 조건이에요.",
    description:
      "제주가 2017년 당근 시범사업으로 시작해 지금까지 운영하는 가격안정 제도예요. 품목별 주 출하기 월별 시장 평균가격이 목표관리 기준가격보다 낮아지면 그 차액의 90%를 보전해 줘요. 당근과 브로콜리는 11월~4월이 주 출하기 기준이고, 신청 상한은 농가당 당근 200톤·브로콜리 40톤이에요. 다만 밭작물 제주형 자조금 단체에 가입해 지역농협으로 계통출하해야 하고, 채소류 재배면적 신고제에 참여하고, 수급 불안으로 자율감축을 할 때 신청량의 10% 이상 참여해야 하는 세 조건을 모두 채워야 해요. 신청은 품목별 계약재배 지역농협에서 받고 해마다 9월에 공고돼 10월 말에 마감돼요(문의 064-728-4812).",
    region: "제주특별자치도",
    organization: "제주특별자치도 / 품목별 계약재배 지역농협",
    supportType: "보조금",
    supportAmount: "목표관리 기준가격보다 하락 시 차액의 90% 보전. 신청 상한 농가당 당근 200톤·브로콜리 40톤",
    eligibilityAgeMin: 18,
    eligibilityAgeMax: 99,
    eligibilityDetail:
  ...
  {
    id: "SP-077",
    title: "제주 토종농작물 생산농가 소득보전 지원사업 (메밀 등 40품종)",
    summary:
      "제주에서 메밀 같은 토종 작물을 키우면 ㎡당 400원, 최대 150만 원을 받을 수 있어요. 해마다 8월 말 공고예요.",
    description:
      "제주도가 사라져 가는 토종 종자를 지키려고 재배 농가에 소득을 보전해 주는 사업이에요. 도가 지정한 토종농작물 40개 품종이 대상이고 메밀이 그 안에 들어 있어요(메밀 단독 사업은 아니에요). 지원단가는 ㎡당 400원이고 농가당 최대 1,500천 원까지 받을 수 있어요. 농업경영체를 등록하고 제주도에 주소를 둔 농업인이 도내 농지에서 재배·관리를 충실히 이행하면 되고, 구비서류는 토종종자 분양 확인서 하나예요. 재배 경력을 요구하지 않아서 그해 토종종자를 분양받으면 갓 정착한 농가도 신청할 수 있어요. 신청은 농지 소재지 읍·면·동 주민센터, 문의는 제주특별자치도 식품산업과(064-710-3143)예요. 2023년부터 4년 연속 공고됐어요.",
    region: "제주특별자치도",
    organization: "제주특별자치도 식품산업과",
    supportType: "보조금",
    supportAmount: "㎡당 400원, 농가당 최대 1,500천 원 (2025년 300원/㎡·18품종 → 2026년 400원/㎡·40품종)",
    eligibilityAgeMin: 18,
    eligibilityAgeMax: 99,
    eligibilityDetail:
