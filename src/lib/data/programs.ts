...
const PROGRAMS_RAW: Omit<SupportProgram, "status">[] = [
  ...
  },
  {
    ...
    description:
      "독립경영 1년차 월 110만원부터 3년차 월 90만원까지 최대 3년간 정착지원금을 받을 수 있어요. 만 18~39세 청년으로 영농경력 3년 이하이며 해당 지자체에 실거주해야 해요. 연간 약 2,000명을 선발하며, 매년 11~12월경 다음 해 대상자를 모집해요. 청년 귀농인의 초기 생활 안정에 실질적으로 도움이 되는 핵심 사업이에요.",
    region: "전국",
  ...
  },
  {
    ...
    description:
      "21세대 규모의 체류형 주거공간과 공동실습농지, 시설하우스, 작업장을 무상으로 이용할 수 있어요. 도시에서 1년 이상 거주한 만 65세 이하 귀농 희망자가 대상이며, 함평군 전입 6개월 이내이거나 이주 예정인 예비귀농인도 신청 가능해요. 실제 농촌에서 생활하며 영농기술을 익힐 수 있는 체류형 프로그램이에요.",
    region: "전라남도",
  ...
  },
  {
    ...
    description:
      "약 10개월간 무안군 내 체류형 주거를 무상으로 제공받으며 영농 이론과 실습 교육을 병행해요. 귀농 전 장기 체류를 통해 지역 환경과 농업 여건을 충분히 파악할 수 있어요. 주거비 부담 없이 안정적으로 귀농 준비를 할 수 있어 초기 정착 실패 위험을 줄여줍니다.",
    region: "전라남도",
    organization: "무안군",
    supportType: "현물",
  ...
  },
  {
    ...
    description:
      "3개월간 영월군에 체류하며 주거, 영농실습, 지역 주민 교류를 경험해요. 5명만 선발하는 소규모 프로그램으로 밀착 지원이 가능하며, 주요 작물 재배기술을 현장에서 습득해요. 귀농 전 실제 농촌생활을 미리 체험해볼 수 있어 정착 여부를 신중하게 판단하는 데 도움이 돼요.",
    region: "강원도",
  ...
  },
  {
    ...
    description:
      "3개월간 영암군에 체류하며 농업 체험뿐 아니라 관광, 지역문화까지 폭넓게 경험할 수 있어요. 체류비용이 지원되어 경제적 부담 없이 참여할 수 있으며, 두 지역 살아보기 형태로 운영돼요. 귀농과 귀촌 모두에 관심 있는 분들이 농촌 정착 가능성을 탐색하기에 적합한 프로그램이에요.",
    region: "전라남도",
  ...
  },
  {
    ...
    description:
      "한국농어촌공사가 운영하는 농지은행이 농사를 짓지 못하게 된 농지 소유주로부터 농지를 위탁받아, 농지가 필요한 농업인에게 임대로 연결해 주는 사업이에요. 귀농인 입장에서는 농지를 매입하지 않고도 안정적으로 농지를 빌릴 수 있어 초기 자본 부담이 크게 줄어요. 2026년 1월 1일부터 농지 소유주(위탁자)에 대한 위탁수수료가 완전히 폐지되어 농지를 내놓는 부담도 사라졌어요. 농지은행 통합포털에서 농지 검색·매물 등록·임대 신청이 모두 가능하고, 콜센터 1577-7770에서도 상담받을 수 있어요.",
    region: "전국",
    ...
    eligibilityAgeMax: 65,
    eligibilityDetail:
      "농지가 필요한 농업인 또는 귀농 예정자. 농지은행 통합포털(fbo.or.kr) 신청 또는 콜센터 1577-7770 상담.",
    applicationStart: "2026-01-01",
    applicationEnd: "9999-12-31",
    relatedCrops: [],
  ...
  },
  {
    ...
    eligibilityAgeMax: 65,
    eligibilityDetail:
      "귀농 희망 도시민. 상월면 상도리 리모델링 주거지 1동. 논산시 농업기술센터 신청.",
