...
export const RESULT_TIERS: ResultTier[] = [
  {
    ...
    description:
      "지금은 귀농이 조금 먼 이야기처럼 느껴질 수 있어요. 하지만 궁금해서 이 테스트를 해봤다는 것 자체가 소중한 시작이에요. 서두를 필요 없이, 귀농이 어떤 것인지 가볍게 알아가는 것부터 시작해보세요. 이랑이 함께할게요!",
    tips: [
  ...
  },
  {
    ...
    emoji: "🌿",
    summary:
      "귀농에 대한 마음은 확실해지고 있어요. 이제 구체적인 준비를 시작할 때예요.",
    description:
      "귀농에 대한 관심이 단순한 호기심을 넘어서고 있어요. 하지만 아직 몇 가지 영역에서 준비가 필요해요. 특히 재정 계획과 실제 농업 경험을 쌓는 것이 다음 단계의 핵심이에요. 준비 기간을 최소 2년 이상 잡고, 하나씩 채워가 보세요.",
    tips: [
  ...
  },
  {
    ...
    description:
      "여러 면에서 귀농 준비가 잘 진행되고 있어요. 재정, 경험, 가족 합의 등 핵심 요소를 상당 부분 갖추고 있어요. 이제는 구체적인 지역과 작물을 선정하고, 현지 답사를 통해 실행 계획을 구체화할 차례예요.",
    tips: [
  ...
  },
  {
    ...
    description:
      "축하해요! 동기, 자금, 가족 합의, 경험, 적응력 모두 높은 준비 상태예요. 이 정도 준비를 갖추고 시작하는 귀농인은 정착 성공률이 훨씬 높아요. 이제 이랑에서 나에게 딱 맞는 지역과 작물을 찾아볼까요?",
    tips: [
