...
export const QUESTIONS: AssessmentQuestion[] = [
  // ── 차원 1: 동기·마인드셋 ──
  {
    ...
    question: "농촌 정착(귀농·귀촌·스마트팜 등 다양한 유형)에 대해 어떤 마음이세요?",
    options: [
  ...
  },
  {
    ...
    dimensionLabel: "동기·마인드셋",
    question:
      "정착 후 처음 1~2년 동안 수입이 거의 없을 수 있다는 걸 알고 계셨나요?",
    options: [
      { label: "처음 알았어요! 농촌 정착 생활이 어떤지 아직 잘 모르겠어요", score: 1 },
      {
  ...
  // ── 차원 2: 재정 준비도 ──
  {
    ...
    question: "현재 농촌 정착을 위해 활용할 수 있는 자금은 어느 정도인가요?",
    options: [
  ...
  },
  {
    ...
    dimensionLabel: "재정 준비도",
    question:
      "정착 후 농외소득(부업, 프리랜서 등)에 대해 어떻게 생각하세요?",
    options: [
      {
      ...
      {
        label:
          "정착 후에도 파트타임 근무나 자영업 등 병행할 계획이 있어요",
        score: 3,
      },
      {
        label:
  ...
  // ── 차원 3: 가족·생활 환경 ──
  {
    ...
    question:
      "가족(배우자, 자녀 등)과 농촌 정착에 대해 얼마나 이야기를 나눠보셨나요?",
    options: [
      {
  ...
  // ── 차원 4: 경험·역량 ──
  {
    ...
    options: [
      ...
      {
        label: "정착 교육을 이수했거나 실제 영농 경험이 있어요",
        score: 4,
      },
    ],
  },
  {
    ...
    dimension: "experience",
    dimensionLabel: "경험·역량",
    question: "농촌 정착을 준비할 때 어디서 정보를 얻으셨나요?",
    options: [
      {
      ...
      {
        label: "SNS나 유튜브에서 농촌 정착 브이로그·채널을 본 적 있어요",
        score: 2,
      },
      {
        label: "농촌 정착 관련 책을 읽거나, 설명회·박람회에 참석해봤어요",
        score: 3,
      },
      {
        label:
...
export const RESULT_TIERS: ResultTier[] = [
  {
    ...
    emoji: "🌱",
    summary:
      "농촌 정착에 대한 관심이 싹트고 있어요! 테스트를 해본 것만으로도 멋진 첫걸음이에요.",
    description:
      "지금은 농촌 정착이 조금 먼 이야기처럼 느껴질 수 있어요. 하지만 궁금해서 이 테스트를 해봤다는 것 자체가 소중한 시작이에요. 서두를 필요 없이, 어떤 정착 유형이 있는지 가볍게 알아가는 것부터 시작해보세요. 이랑이 함께할게요!",
    tips: [
      "귀농귀촌종합센터의 무료 온라인 교육부터 가볍게 시작해보세요",
      "주말에 가까운 체험 농장을 방문해서 농사의 현실을 느껴보세요",
      "이랑의 정착 선배 인터뷰를 읽으며 다양한 정착 이야기를 만나보세요",
    ],
  ...
  },
  {
    ...
    emoji: "🌿",
    summary:
      "농촌 정착에 대한 마음은 확실해지고 있어요. 이제 구체적인 준비를 시작할 때예요.",
    description:
      "농촌 정착에 대한 관심이 단순한 호기심을 넘어서고 있어요. 하지만 아직 몇 가지 영역에서 준비가 필요해요. 특히 재정 계획과 실제 농업 경험을 쌓는 것이 다음 단계의 핵심이에요. 준비 기간을 최소 2년 이상 잡고, 하나씩 채워가 보세요.",
    tips: [
      "월 저축 목표를 세우고, 정착 자금 계획표를 작성해보세요",
      "주말농장을 1년 이상 운영하며 작물 재배의 전 과정을 경험해보세요",
      "가족과 진지하게 정착 계획을 논의하고, 조건과 타임라인을 합의해보세요",
    ],
    matchParams: { experience: "none", lifestyle: "near-city" },
  },
  {
    ...
    emoji: "🪴",
    summary:
      "상당한 준비가 되어 있어요! 부족한 부분만 보강하면 곧 시작할 수 있어요.",
    description:
      "여러 면에서 정착 준비가 잘 진행되고 있어요. 재정, 경험, 가족 합의 등 핵심 요소를 상당 부분 갖추고 있어요. 이제는 구체적인 지역과 작물을 선정하고, 현지 답사를 통해 실행 계획을 구체화할 차례예요.",
    tips: [
      "관심 지역을 2~3곳으로 좁히고, 직접 방문하여 현지 농업인과 대화해보세요",
      "농촌 정착 지원사업 신청 자격을 미리 확인하고, 필요한 서류를 준비해두세요",
  ...
  },
  {
    ...
    emoji: "🌾",
    summary:
      "충분한 준비를 마치셨어요! 이제 나만의 이랑을 만들어갈 차례예요.",
    description:
      "축하해요! 동기, 자금, 가족 합의, 경험, 적응력 모두 높은 준비 상태예요. 이 정도 준비를 갖추고 시작하는 정착자는 성공률이 훨씬 높아요. 이제 이랑에서 나에게 딱 맞는 지역과 작물을 찾아볼까요?",
    tips: [
...
export const DIMENSION_GUIDES: DimensionGuide[] = [
  /* ── 동기·마인드셋 ── */
  {
    ...
    guides: [
      {
        tier: "critical",
        message: "농촌 정착에 대한 현실적인 이해가 필요한 단계예요",
        actions: [
          {
            title: "정착 선배 인터뷰 읽어보기",
            description: "먼저 정착한 분들의 생생한 경험담을 통해 농촌 생활의 현실을 파악해보세요.",
            link: "/interviews",
            linkLabel: "인터뷰 보러 가기",
            priority: 1,
            estimatedTime: "30분",
          },
          {
            ...
            description: "농림축산식품부가 운영하는 무료 온라인 기초 교육으로 농촌 정착의 전체 그림을 그려보세요.",
            link: "/education",
      ...
      {
        tier: "weak",
        message: "정착 동기를 더 구체적으로 다듬어볼 단계예요",
        actions: [
          {
            title: "정착 선배 인터뷰로 동기 점검",
            description: "나와 비슷한 상황에서 농촌으로 간 선배들의 이야기를 읽으며 동기를 구체화해보세요.",
            link: "/interviews",
            linkLabel: "인터뷰 보러 가기",
            priority: 1,
            estimatedTime: "30분",
          ...
          {
            title: "농촌 정착 가이드로 전체 프로세스 파악",
            description: "정착 준비부터 안착까지의 단계별 가이드를 확인하며 나만의 계획을 세워보세요.",
            link: "/guide",
            linkLabel: "가이드 읽기",
            priority: 2,
            estimatedTime: "1시간",
  ...
  /* ── 재정 준비도 ── */
  {
    ...
    guides: [
      {
        tier: "critical",
        message: "재정 계획이 정착 성공의 가장 중요한 열쇠예요",
        actions: [
          {
            title: "정착 비용 구조 파악하기",
    ...
    guides: [
      {
        ...
        actions: [
          {
            title: "정착 선배 가족의 이야기 읽기",
            description: "가족과 함께 농촌으로 간 선배들의 경험담을 공유하며 대화의 실마리를 찾아보세요.",
            link: "/interviews",
            linkLabel: "인터뷰 보러 가기",
            priority: 1,
            estimatedTime: "30분",
    ...
    guides: [
      ...
      },
      {
        ...
        actions: [
          ...
          {
            title: "정착 커뮤니티·행사 참여",
            description: "농촌 정착 박람회나 설명회에 참석하면 비슷한 고민을 가진 동료를 만날 수 있어요.",
            link: "/events",
            linkLabel: "행사·이벤트 보기",
            priority: 2,
            estimatedTime: "반나절",
