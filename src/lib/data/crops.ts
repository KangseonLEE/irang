...
export const CROPS: CropInfo[] = [
  ...
  // 과수류
  {
    ...
    difficulty: "어려움",
    description:
      "대구·경북이 전통 주산지이나 기후변화로 강원·충북으로 재배지 이동 중. 초기 투자비가 커요.",
    emoji: "🍎",
  },
  {
    id: "pear",
  ...
  // 2026-05-29 회장 결재 — 임산물 3종 정식 승격 (특용작물)
  // 출처: 산림청 2024 임산물 표준소득 / 임업경영실태조사 / KATI 품목 / KOSIS 임산물생산량
  // cost-by-type.ts forestry 탭 수치와 정합
  {
    id: "omija",
    name: "오미자",
    category: "특용",
    growingSeason: "4월~5월 (개화), 8월~9월 (수확), 다년생 (식재 후 3년차부터 결실)",
    difficulty: "보통",
    description:
      "신맛·단맛·쓴맛·매운맛·짠맛 다섯 가지 맛을 내는 붉은 열매예요. 경북 문경이 전국 생산량의 절반 이상을 차지하는 대표 산지이고, 청·차·즙 가공으로 산간 정착 농가의 주요 소득원이 돼요.",
    emoji: "🔴",
  },
  {
    id: "chestnut",
    name: "밤",
    category: "특용",
    growingSeason: "5월~6월 (개화), 9월~10월 (수확), 다년생 (식재 후 5~7년차 본격 수확)",
    difficulty: "보통",
    description:
      "충남 공주·부여와 경남이 대표 산지인 대표 단기소득 임산물이에요. 한 번 조성하면 수십 년 수확하고, 임야를 활용해 평지 농지 없이도 시작할 수 있어요.",
    emoji: "🌰",
  },
  {
    id: "walnut",
    name: "호두",
    category: "특용",
    growingSeason: "4월~5월 (개화), 9월~10월 (수확), 다년생 (식재 후 7~10년차 본격 수확)",
    difficulty: "어려움",
    description:
      "경북 김천·충북 영동이 대표 산지예요. 결실까지 7~10년 걸리는 장기 투자 작목이지만, 국산 호두 수요가 꾸준하고 한 번 조성하면 수십 년 수확해요.",
    emoji: "🥥",
  },
  ...
  },
  {
    ...
    name: "국화",
    category: "화훼",
    growingSeason: "연중 (전조·차광으로 개화 조절)",
    difficulty: "보통",
    description:
      "국내 절화 판매량에서 가장 큰 비중을 차지하는 화훼예요. 전조·차광으로 개화 시기를 옮겨 성수기에 맞춰 낼 수 있어요.",
    emoji: "🌼",
  },
  {
    id: "lily",
    name: "백합",
    category: "화훼",
    growingSeason: "연중 (작형별 출하)",
    difficulty: "보통",
    description:
      "구근을 심어 4~6개월 만에 절화를 내는 화훼예요. 강원은 여름, 제주는 겨울, 충남은 봄·가을로 출하 시기가 갈려요.",
    emoji: "🌸",
  },
];
...
export const CROP_DETAILS: CropDetailInfo[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      "고온기(6~8월) 25℃ 이상에서 추대(꽃대)가 올라오면 상품성이 없어져요. 흑백 이중 필름 차광과 환기가 핵심.",
  ...
  // Phase 7 B D5 — 작물 detail 10건 보강 (2026-05-22, CROP_DETAILS 39→49종)
  // CROPS line 619~717와 1:1 매핑. 출처: RDA 농산물소득자료집 2024 / 농사로 표준영농기술교본 / KOSIS / KATI
  {
    id: "cherry-tomato",
    cultivation: {
      climate: "생육적온 25~28℃(주간), 15~18℃(야간). 일교차가 클수록 당도 상승. 시설재배는 연중 가능",
      soil: "배수 양호한 사질양토, pH 6.0~6.5. 유기물 함량 높은 토양 선호",
      water: "점적관수 권장. 비대기 절수로 당도 향상. 과습 시 열과 발생",
      spacing: "이랑 폭 120~150cm, 주간 35~40cm (10a당 약 1,800~2,200주)",
    ...
    tips: [
      ...
      "스테비아·흑방울 등 기능성 품종으로 차별화하면 kg당 단가가 1.5~2배 높아져요.",
      "꿀벌·뒤영벌 수분이 필수예요. 시설 내 벌통 1~2통 투입을 잊지 마세요.",
    ],
    ...
    prosCons: {
      ...
      cons: [
        { category: "재배난이도", text: "매일 수확·유인이 필요해 연중 노동 강도가 매우 높아요" },
        { category: "수익성", text: "시설 투자비와 겨울 난방비 부담이 커서 초기 자본이 많이 필요해요" },
      ],
      verdict: "시설채소 최상위권 소득과 안정 수요가 매력. 난방비 절감 기술·직거래 판로가 성패를 좌우해요.",
    },
    cultivationSteps: [
      { step: 1, title: "육묘·정식", period: "시설 겨울작: 1~2월 / 봄작: 3~4월", description: "128공 트레이에 파종 후 35~40일 육묘. 본잎 7~8매 시 정식. 지온 15℃ 이상 확보" },
      { step: 2, title: "유인·곁순 제거", period: "정식 후 2~3주부터", description: "줄기를 유인끈으로 고정하고 곁순 제거. 1줄기 재배 기본. 8~10화방 이후 적심" },
      { step: 3, title: "착과·비대 관리", period: "정식 후 40일~", description: "뒤영벌 수분 활용. 칼슘제 엽면시비로 배꼽썩음과 예방. 1화방 6~8과 적과" },
      { step: 4, title: "수확·출하", period: "정식 후 70~80일부터 매일", description: "완전 착색 시 수확. 1팩(500g·1kg) 선별·포장. 직거래 출하 시 당일 발송" },
    ],
    investmentDetail: {
      initialCost: "시설(하우스·난방·관수) 10a당 약 3,000~5,000만 원",
      annualOperatingCost: "10a당 약 500~900만 원 (난방비·인건비·자재비)",
      breakEvenPeriod: "3~4년 (시설 투자 회수 기준)",
      minimumArea: "시설 500평 이상",
      annualLaborDays: "연 220~260일 (연중 수확·관리)",
    },
  },
  {
    id: "eggplant",
    cultivation: {
      climate: "고온성 작물, 생육적온 23~28℃. 13℃ 이하에서 생장 정지. 일조량 충분 필수",
      soil: "배수 양호한 양토~사질양토, pH 6.0~6.8. 유기물 풍부한 토양 선호",
      water: "수분 요구량 많음. 토양 수분 70~80% 유지. 건조 시 열매가 단단해짐",
      spacing: "이랑 폭 120~150cm, 주간 50~60cm (10a당 약 1,200~1,500주)",
    ...
    tips: [
      ...
      "오랜 수확 기간 동안 영양분이 빠지므로 추비를 게을리하면 후반 수량이 급감해요.",
      "지나치게 큰 과실은 단단해지고 씨가 많아져요. 적기 수확이 품질의 핵심이에요.",
    ],
    ...
    prosCons: {
      ...
      cons: [
        { category: "재배난이도", text: "병해충(진딧물·점박이응애·잿빛곰팡이) 관리가 까다로워요" },
        { category: "수익성", text: "kg당 단가가 토마토 대비 낮아 규모가 필요해요" },
      ],
      verdict: "시설채소 상위 소득과 노동 분산이 강점. 적기 수확과 추비 관리가 후반 수익을 결정해요.",
    },
    cultivationSteps: [
      { step: 1, title: "육묘·정식", period: "시설: 2~3월 / 노지: 4~5월", description: "접목묘 60~70일 육묘. 본잎 7~8매·1번화 개화 시 정식. 지온 15℃ 이상 확보" },
      { step: 2, title: "유인·정지", period: "정식 후 2~3주", description: "주지 2~3본 V자 유인. 1번화 아래 곁순 모두 제거. 도장지 정리" },
      { step: 3, title: "착과·추비", period: "정식 후 30~40일", description: "1번화 착과 확인 후 추비 시작. 2~3주 간격 분시. 노화 잎 적엽으로 통풍 확보" },
      { step: 4, title: "수확", period: "정식 후 60~70일부터 연속 수확", description: "꽃 핀 후 25~30일 경 수확. 과실 길이 15~20cm·표면 광택 시 적기" },
    ],
    investmentDetail: {
      initialCost: "시설(하우스·관수) 10a당 약 2,500~4,500만 원",
      annualOperatingCost: "10a당 약 400~700만 원",
      breakEvenPeriod: "3~4년",
      minimumArea: "시설 500평 이상",
      annualLaborDays: "약 180~220일",
    },
  },
  {
    id: "asparagus",
    cultivation: {
      climate: "내한성 강함, 생육적온 15~20℃. 겨울 휴면 후 봄 발순. 다년생(10~15년)",
      soil: "배수 양호한 사질양토~양토, pH 6.0~7.5. 토심 깊은 곳 필수(뿌리가 1m 이상 발달)",
      water: "휴면기 절수, 생육기 충분한 관수. 과습에 약함",
      spacing: "이랑 폭 150~180cm, 주간 30~40cm (10a당 약 1,500~2,200주)",
    ...
    tips: [
      "정식 후 2년차까지는 수확하지 않고 뿌리를 키워야 10년 이상 수확이 가능해요.",
      "봄철 단가가 가장 높아요. 3~5월 수확분이 연간 매출의 70% 이상을 차지해요.",
      "수확 후 즉시 냉수 침지·예냉하면 신선도와 상품성이 크게 올라가요.",
      "청년농 신소득 작목으로 RDA 매뉴얼·교육이 잘 정리돼 있어요. 정식 전 교육 권장.",
    ],
    relatedCropIds: ["broccoli", "lettuce", "spinach"],
    prosCons: {
      pros: [
        { category: "수익성", text: "한 번 심으면 10년 이상 수확하는 다년생으로 장기 안정 소득이 가능해요" },
        { category: "시장성", text: "프리미엄 채소로 봄철 단가가 높고 호텔·고급 마트 수요가 두터워요" },
        { category: "확장성", text: "청년농 신소득 작목으로 정부 지원·교육이 활발해요" },
      ],
      cons: [
        { category: "수익성", text: "정식 후 2년차까지 수확이 없어 초기 투자 회수까지 3~4년 걸려요" },
        { category: "재배난이도", text: "토심·배수 등 입지 조건이 까다롭고 정식 후 변경이 불가해요" },
      ],
      verdict: "초기 2년 투자만 견디면 10년 이상 안정 수익. 청년농 정부 지원과 결합하면 추천도 높아요.",
    },
    cultivationSteps: [
      { step: 1, title: "정식 준비·식재", period: "1년차 3~4월", description: "깊이 30cm 식재구 조성·퇴비 충분 시용. 1년생 묘 또는 종근 정식. 줄간 1.5m 확보" },
      { step: 2, title: "1~2년차 양성", period: "정식 후 1~2년", description: "줄기 자유 생장 → 뿌리 비대. 수확 금지. 풀 관리·관수 위주. 가을 줄기 잘라 매년 갱신" },
      { step: 3, title: "수확기 관리", period: "3년차부터 매년 3~6월", description: "지상부 20~25cm 시 굴취 수확. 일 1회·기간 60~80일. 수확 종료 후 줄기 자유 생장 허용" },
      { step: 4, title: "휴면·갱신", period: "매년 11~12월", description: "지상부 황변 시 절단·정리. 휴면기 전 추비 1회로 이듬해 수확량 확보" },
    ],
    investmentDetail: {
      initialCost: "10a당 약 700~1,500만 원 (묘목·심경·관수 시설 포함)",
      annualOperatingCost: "10a당 약 200~400만 원 (3년차부터)",
      breakEvenPeriod: "4~5년 (정식~3년차 수확 회수 기준)",
      minimumArea: "1,000평 이상",
      annualLaborDays: "약 120~160일 (수확기 집중)",
    },
  },
  {
    id: "broccoli",
    cultivation: {
      climate: "서늘한 기후 선호, 생육적온 15~20℃. 25℃ 이상에서 결구 불량. 제주·남부 겨울 노지 적합",
      soil: "배수 양호한 양토, pH 6.0~6.8. 유기물 풍부한 토양",
      water: "결구기 충분한 관수. 토양 수분 70% 유지",
      spacing: "이랑 폭 60~70cm, 주간 35~40cm (10a당 약 3,500~4,500주)",
    ...
    tips: [
      "제주가 전국 재배면적의 약 72%를 차지해요. 김장철 이후 비수기에 출하해 시장 공백을 메우는 작목이에요.",
      "결구가 단단할 때 수확해야 상품성이 좋아요. 늦으면 꽃봉오리가 벌어져요.",
      "수확 후 즉시 예냉(0~1℃)하면 선도가 1~2주 유지돼요.",
      "측화뢰(곁꽃봉오리)도 2차 수확이 가능해 단위 면적당 총 수량을 늘릴 수 있어요.",
    ],
    relatedCropIds: ["napa-cabbage", "radish", "asparagus"],
    prosCons: {
      pros: [
        { category: "재배난이도", text: "재배 기간 짧고(60~90일) 시설 없이도 가능해 진입 장벽이 낮아요" },
        { category: "시장성", text: "건강·다이어트 식재료로 수요가 꾸준히 늘고 있어요" },
        { category: "안정성", text: "겨울 비수기 출하로 시장 공백을 메우는 작목이에요" },
      ],
      cons: [
        { category: "수익성", text: "kg당 단가가 낮은 편이라 규모화가 필요해요" },
        { category: "안정성", text: "고온기에는 결구 불량으로 재배가 어려워요" },
      ],
      verdict: "초보 귀농에 진입하기 좋은 작물. 제주·남부 겨울 노지에 적합하고 예냉 시설로 부가가치를 높일 수 있어요.",
    },
    cultivationSteps: [
      { step: 1, title: "육묘", period: "제주: 8~9월 / 남부: 7~8월", description: "200공 트레이에 파종 후 30~35일 육묘. 본잎 4~5매 시 정식 적기" },
      { step: 2, title: "정식·초기 관리", period: "제주: 9~10월", description: "이랑 폭 60cm·주간 35cm 정식. 활착 후 추비 1차 시작" },
      { step: 3, title: "결구기 관리", period: "정식 후 40~50일", description: "추비 3~4회 분시. 배추좀나방·진딧물 방제. 결구 시작 시 충분한 관수" },
      { step: 4, title: "수확·출하", period: "정식 후 60~90일", description: "꽃봉오리 단단할 때 줄기째 절단. 예냉 후 출하. 측화뢰 발생 시 2차 수확" },
    ],
    investmentDetail: {
      initialCost: "10a당 약 100~250만 원 (종자·비료·기본 농기구)",
      annualOperatingCost: "10a당 약 150~300만 원 (인건비·자재비)",
      breakEvenPeriod: "1년차부터 수익 가능",
      minimumArea: "1,000평 이상",
      annualLaborDays: "약 70~100일",
  ...
  },
  {
    id: "paprika",
    cultivation: {
      climate: "고온성 작물, 생육적온 22~28℃. 시설 내 환경 제어 필수. 일조량 충분",
      soil: "수경재배가 표준(코코피트·암면). 토경재배 시 사질양토, pH 6.0~6.5",
      water: "수경재배 양액 자동 공급. EC·pH 정밀 관리 필수",
      spacing: "이랑 폭 150cm, 주간 35~40cm (10a당 약 1,800~2,200주)",
    ...
    tips: [
      ...
      "색별 수확(빨강·노랑·주황)으로 시장 차별화. 빨간색이 가장 단가가 높아요.",
      "스마트팜 청년창업 보육센터 등 정부 지원으로 시설 부담을 낮출 수 있어요.",
    ],
    relatedCropIds: ["chili-pepper", "tomato", "cherry-tomato"],
    prosCons: {
      pros: [
        { category: "수익성", text: "수경재배 시 시설채소 최상위권 소득이 가능해요" },
        { category: "시장성", text: "일본 수출 주력 작목으로 단가가 안정적이에요" },
        { category: "확장성", text: "스마트팜·수출 농가로 정부 지원과 청년농 우대가 활발해요" },
      ],
      cons: [
        { category: "수익성", text: "시설 투자비가 10a당 1억 원 이상으로 매우 큰 진입 장벽이에요" },
        { category: "안정성", text: "수출 의존도가 높아 환율·검역 이슈에 민감해요" },
        { category: "재배난이도", text: "환경 제어 실패 시 수량·품질 손실이 즉각 발생해요" },
      ],
      verdict: "고소득·고난도 첨단 작목. 스마트팜 청년창업 등 정부 지원과 결합한 수출 농가 모델이 적합해요.",
    },
    cultivationSteps: [
      { step: 1, title: "육묘·정식", period: "여름작: 7~8월 / 겨울작: 1~2월", description: "전문 육묘장 위탁 70~80일. 본잎 8~10매 시 수경 시설에 정식" },
      { step: 2, title: "유인·정지", period: "정식 후 2~3주~", description: "줄기 2~3본 유인. 분지 정리. 양액 EC 2.5~3.0·pH 5.5~6.0 정밀 관리" },
      { step: 3, title: "착과·환경 제어", period: "정식 후 40~50일", description: "마디마다 착과. 1주당 30~40과 목표. 온실 야간 18~20℃·CO₂ 800~1,000ppm 유지" },
      { step: 4, title: "수확·선별·수출", period: "정식 후 80~90일부터 매주", description: "완전 착색 후 수확. 색·크기 자동선별. 수출 검역 통과 후 컨테이너 출하" },
    ],
    investmentDetail: {
      initialCost: "스마트팜 첨단온실 10a당 약 1억 5,000만 원 이상",
      annualOperatingCost: "10a당 약 2,500~4,000만 원 (양액·전력·인건비)",
      breakEvenPeriod: "5~7년 (시설 회수 기준)",
      minimumArea: "시설 1,000평 이상",
      annualLaborDays: "연 240~280일",
    },
  },
  {
    id: "carrot",
    cultivation: {
      climate: "서늘한 기후 선호, 생육적온 15~20℃. 25℃ 이상에서 뿌리 비대 불량",
      soil: "배수 양호한 사질양토 필수. pH 6.0~6.5. 토심 깊고 자갈 없는 토양",
      water: "발아기·뿌리 비대기 충분한 관수. 과습 시 열근 발생",
      spacing: "이랑 폭 120cm, 줄간 25cm, 주간 5~7cm (10a당 약 80,000~120,000주)",
    ...
    tips: [
      ...
      "발아율을 높이려면 파종 후 짚 멀칭 또는 부직포 피복을 해주세요.",
      "기계 수확용 품종(곧고 크기 균일)을 선택하면 인건비를 크게 줄일 수 있어요.",
    ],
    relatedCropIds: ["radish", "potato", "garlic"],
    prosCons: {
      pros: [
        { category: "시장성", text: "김장·국·반찬에 두루 쓰이는 기본 근채류로 수요가 안정적이에요" },
        { category: "재배난이도", text: "기계화 보급률이 높아 대면적 운영이 가능해요" },
        { category: "안정성", text: "제주 월동당근은 비수기 출하로 가격이 비교적 안정적이에요" },
      ],
      cons: [
        { category: "재배난이도", text: "사질양토·심토 등 입지 조건이 까다로워요" },
        { category: "수익성", text: "단가가 낮아 규모화 없이는 소득이 제한적이에요" },
      ],
      verdict: "기계화·대면적이 가능한 안정 작목. 제주·평창 등 주산지 입지가 핵심이에요.",
    },
    cultivationSteps: [
      { step: 1, title: "파종·발아", period: "봄: 3~4월 / 가을: 7~8월 / 제주: 8~9월", description: "기계 줄뿌림. 복토 1cm. 발아 적온 15~20℃. 발아까지 10~14일" },
      { step: 2, title: "솎음·추비", period: "본잎 2~3매 시 / 5~6매 시", description: "1차 솎음으로 주간 3cm 확보, 2차 솎음으로 5~7cm 확보. 추비 1회" },
      { step: 3, title: "비대기 관리", period: "파종 후 60~90일", description: "토양 수분 70% 유지. 잡초 관리 철저. 무름병·검은무늬병 방제" },
      { step: 4, title: "수확·세척·출하", period: "파종 후 100~140일", description: "잎이 시들기 전 수확. 기계 수확 시 일시 출하. 세척·선별 후 박스 출하" },
    ],
    investmentDetail: {
      initialCost: "10a당 약 100~200만 원 (종자·비료·기본 농기구)",
      annualOperatingCost: "10a당 약 150~300만 원 (인건비·자재비)",
      breakEvenPeriod: "1년차부터 수익 가능",
      minimumArea: "1,000평 이상",
      annualLaborDays: "약 80~110일",
    },
  },
  {
    id: "king-oyster-mushroom",
    cultivation: {
      climate: "발생 적온 14~18℃. 습도 85~95%. 환기·CO₂ 관리 중요",
      soil: "배지: 미송톱밥·옥수수속·면실박 혼합. 병 단위(850~1,100cc) 충진·살균",
      water: "공간 분무로 습도 유지. 직접 자실체에 닿지 않게 측면 가습",
      spacing: "다단 선반식(8~12단). 10a 시설 기준 약 80,000~120,000병 적재",
    ...
    tips: [
      "병재배가 표준화돼 연중 생산이 가능해요. 표고·느타리와 구분되는 별도 작목이에요.",
      "식감이 단단해 외식·급식 수요가 꾸준해요. 학교급식 계약 재배로 안정 판로 확보가 가능해요.",
      "여름 냉방비가 수익의 20~30%를 차지해요. 단열·고효율 냉방 투자가 장기적으로 유리해요.",
      "병당 수확량이 시설·배지 품질에 좌우돼요. 자동 입봉·접종 라인을 권장해요.",
    ],
    relatedCropIds: ["oyster-mushroom", "shiitake", "lettuce"],
    prosCons: {
      pros: [
        { category: "안정성", text: "연중 시설 생산으로 계절 변동 없이 꾸준한 소득이 가능해요" },
        { category: "시장성", text: "외식·급식·마트 B2B 판로가 안정적이에요" },
        { category: "재배난이도", text: "병재배가 표준화돼 매뉴얼대로 관리가 가능해요" },
      ],
      cons: [
        { category: "수익성", text: "냉난방 전기료·배지 원재료비 부담이 크고 단가는 평이해요" },
        { category: "재배난이도", text: "잡균 오염·CO₂ 관리 실패 시 수량 손실이 커요" },
      ],
      verdict: "표준화·자동화가 가능한 시설 버섯. 자동 입봉 라인·고효율 냉방으로 규모화하면 안정 소득.",
    },
    cultivationSteps: [
      { step: 1, title: "배지 제조·살균", period: "연중", description: "톱밥·옥수수속·면실박 배합 → 병 충진(850~1,100cc) → 고압살균(121℃, 90분)" },
      { step: 2, title: "접종·배양", period: "살균 후 즉시", description: "무균실 종균 접종. 온도 22~25℃·습도 60~70%에서 30~40일 배양" },
      { step: 3, title: "발생·생육", period: "배양 완료 후", description: "병 개구 → 온도 14~18℃·습도 90% 유지. 환기 충분히. 자실체 발생까지 5~7일" },
      { step: 4, title: "수확·포장", period: "발생 후 7~10일", description: "갓 직경 3~4cm·대 길이 8~12cm 시 수확. 100~200g 팩 포장 후 냉장 출하" },
    ],
    investmentDetail: {
      initialCost: "시설(재배사·살균·냉방·자동화) 10a당 약 3,000~6,000만 원",
      annualOperatingCost: "10a당 약 800~1,500만 원 (배지·전기·인건비)",
      breakEvenPeriod: "3~4년",
      minimumArea: "시설 200평 이상",
      annualLaborDays: "약 260~300일",
    },
  },
  {
    id: "maesil",
    cultivation: {
      climate: "생육적온 18~25℃. 내한성 보통. 개화기(3월) 늦서리 피해 주의",
      soil: "배수 양호한 양토~사질양토, pH 6.0~6.5. 경사지·구릉지 적합",
      water: "건조에 비교적 강함. 과실 비대기(4~5월) 적정 관수",
      spacing: "열간 6m, 주간 5m (10a당 약 30~40주). 식재 후 4~5년차부터 결실",
    ...
    tips: [
      ...
      "자두(plum)와는 다른 별도 작목이에요. 묘목·관리 방법이 달라요.",
      "수확 후 24시간 이내 가공해야 향과 산미가 살아요. 산지 가공장 가까이 위치가 유리해요.",
    ],
    relatedCropIds: ["plum", "peach", "ginger"],
    prosCons: {
      pros: [
        { category: "확장성", text: "매실청·매실주 등 가공품으로 부가가치를 2~3배 높일 수 있어요" },
        { category: "시장성", text: "전통 식품·건강식품 수요가 꾸준하고 산지 브랜드(광양·순창)가 강해요" },
        { category: "생활", text: "수확기 외에는 관리 부담이 적어 부업형 귀농에 적합해요" },
      ],
      cons: [
        { category: "수익성", text: "식재 후 4~5년 결실까지 투자 기간이 길어요" },
        { category: "안정성", text: "개화기 늦서리 피해로 격년결실(해마다 수량 변동)이 잦아요" },
      ],
      verdict: "장기 투자형 과수. 가공·6차산업 연계로 수익을 극대화하고, 광양·순창권 식재가 유리해요.",
    },
    cultivationSteps: [
      { step: 1, title: "식재", period: "11~3월 (휴면기)", description: "1~2년생 묘목 식재. 수분수 10~20% 혼식. 경사지·구릉지 활용" },
      { step: 2, title: "전정·꽃눈 관리", period: "12~2월", description: "도장지 제거, 결과지 배분. 개심자연형 또는 변칙주간형 수형" },
      { step: 3, title: "착과·비대 관리", period: "3~5월", description: "개화 후 늦서리 방지(연막·관수). 5월 비대기 적정 관수. 진딧물·검은별무늬병 방제" },
      { step: 4, title: "수확·가공", period: "5월 말~6월 중순", description: "청매실은 과실이 단단할 때, 황매실은 황색 착색 시 수확. 24시간 이내 가공 또는 산지 출하" },
    ],
    investmentDetail: {
      initialCost: "10a당 약 400~800만 원 (묘목·지주·기본 시설)",
      annualOperatingCost: "10a당 약 100~250만 원",
      breakEvenPeriod: "5~6년 (식재~결실 회수 기준)",
      minimumArea: "1,000평 이상",
      annualLaborDays: "약 80~120일",
    },
  },
  {
    id: "deodeok",
    cultivation: {
      climate: "생육적온 15~20℃. 반음지 환경 선호. 내한성 강해 산지·고랭지 적합",
      soil: "배수 양호한 부식질 사질양토, pH 5.5~6.5. 토심 깊고 부엽토 풍부한 토양",
      water: "건조에 약함. 산림 부산물형 재배 시 자연 강우로 충분",
      spacing: "이랑 폭 90~120cm, 주간 15~20cm (10a당 약 30,000~50,000주)",
    ...
    tips: [
      "산림 부산물형 약용·식용 작물이에요. 산지·임야 활용에 적합하고 평지 농지보다 토지 비용이 낮아요.",
      "2~3년근부터 소득성이 본격화돼요. 1년근은 약효·향이 약해 단가가 낮아요.",
      "더덕구이·더덕주 등 가공품 연계로 부가가치를 높일 수 있어요.",
      "반음지 환경(차광망 30~50%) 또는 자연 임상에서 키우면 향이 진해져요.",
    ],
    relatedCropIds: ["bellflower", "ginseng", "ginger"],
    prosCons: {
      pros: [
        { category: "확장성", text: "산지·임야 활용으로 평지 농지 없이도 시작 가능해요" },
        { category: "시장성", text: "건강식품·전통주 등 가공품 수요가 꾸준해요" },
        { category: "재배난이도", text: "내한성이 강해 고랭지·산지에서 잘 자라요" },
      ],
      cons: [
        { category: "수익성", text: "2~3년 재배해야 수확 가능해 초기 투자 기간이 있어요" },
        { category: "재배난이도", text: "산지 작업 환경상 수확(굴취)·운반이 힘들어요" },
      ],
      verdict: "산지·임야 활용형 약용작물. 강원·경북 산림지대에 적합하고 가공 연계로 수익 안정화 가능.",
    },
    cultivationSteps: [
      { step: 1, title: "파종", period: "3~4월 직파 또는 가을 파종", description: "줄뿌림 후 얇게 복토. 부엽토·짚 멀칭으로 발아율 향상. 발아까지 20~30일" },
      { step: 2, title: "1~2년차 관리", period: "파종 후 1~2년", description: "제초 관리가 핵심. 중경·배토 1~2회. 차광망 30~50% 또는 자연 임상 활용" },
      { step: 3, title: "수확(굴취)", period: "2~3년차 가을 (10~11월)", description: "잎이 황변한 후 굴취. 뿌리 손상 최소화. 흙 제거 후 선별·세척" },
      { step: 4, title: "출하·가공", period: "수확 후", description: "생더덕 또는 건조·가공(더덕구이·더덕주) 후 출하. 산지 직거래·약재상 납품" },
    ],
    investmentDetail: {
      initialCost: "10a당 약 50~200만 원 (종자·차광망·기본 농기구)",
      annualOperatingCost: "10a당 약 80~180만 원 (인건비·제초·자재비)",
      breakEvenPeriod: "3~4년",
      minimumArea: "1,000평 이상",
      annualLaborDays: "약 80~120일",
    },
  },
  {
    id: "buckwheat",
    cultivation: {
      climate: "서늘한 기후 선호, 생육적온 17~22℃. 짧은 생육 기간(70~80일). 척박지 적응력 강함",
      soil: "토양 적응성 넓음. 사질양토~점질양토까지 가능. pH 5.5~7.0. 척박지도 재배 가능",
      water: "건조에 비교적 강함. 발아기·개화기 적정 관수",
      spacing: "산파 또는 줄뿌림(이랑 폭 30~40cm). 10a당 종자 4~5kg",
    ...
    tips: [
      ...
      "이모작(밀·보리 후작) 또는 단기 회전 작목으로 토지 활용도를 높일 수 있어요.",
      "메밀밭은 9월 흰꽃이 만개해 관광 자원이 돼요. 봉평 효석문화제처럼 관광·체험 연계가 가능해요.",
    ],
    relatedCropIds: ["rice", "soybean", "corn"],
    prosCons: {
      pros: [
        { category: "재배난이도", text: "생육 기간 짧고(70~80일) 비료·관리 부담이 적어요" },
        { category: "확장성", text: "메밀국수·전통 식품 가공 + 메밀밭 관광 자원으로 6차산업 연계가 가능해요" },
        { category: "안정성", text: "척박지·휴경지에서도 재배 가능해 진입 장벽이 매우 낮아요" },
      ],
      cons: [
        { category: "수익성", text: "단가가 낮아 전업 소득원으로는 부족해요. 부업·이모작 형태가 적합해요" },
        { category: "시장성", text: "수입산 메밀과의 가격 경쟁이 있어 국산 차별화가 필요해요" },
      ],
      verdict: "부업·이모작형 식량작물. 봉평·평창권 가공·관광 연계 시 수익 다각화가 가능해요.",
    },
    cultivationSteps: [
      { step: 1, title: "파종", period: "여름 메밀: 5~6월 / 가을 메밀: 7~8월", description: "기계 산파 또는 줄뿌림. 종자 4~5kg/10a. 복토 1~2cm" },
      { step: 2, title: "초기 관리", period: "파종 후 10~20일", description: "발아 후 솎음 불필요. 잡초 관리 1~2회. 진딧물 발생 시 방제" },
      { step: 3, title: "개화·결실", period: "파종 후 30~45일", description: "8~9월 흰꽃 만개. 벌·곤충 수분 활용. 도복 방지 위해 추비 절제" },
      { step: 4, title: "수확·도정", period: "파종 후 70~80일", description: "꼬투리 70% 갈변 시 일제 수확. 콤바인 수확 가능. 건조 후 도정·가공" },
    ],
    investmentDetail: {
      initialCost: "10a당 약 20~80만 원 (종자·기본 농기계 임차)",
      annualOperatingCost: "10a당 약 30~100만 원",
      breakEvenPeriod: "1년차부터 수익 가능",
      minimumArea: "1,000평 이상 (이모작 권장)",
      annualLaborDays: "약 30~50일",
    },
  },

  // 2026-05-29 회장 결재 — 임산물 3종 정식 승격 detail
  // 수치는 산림청 2024 임산물 표준소득 + 임업경영실태조사 기준. cost-by-type.ts forestry 탭과 정합
  {
    id: "omija",
    cultivation: {
      climate: "서늘하고 일교차 큰 산간·준고랭지 선호. 생육적온 18~25℃. 내한성 강함",
      soil: "배수 양호한 부식질 사질양토, pH 5.5~6.5. 경사지·산지 토양 적합",
      water: "건조에 약함. 개화기·과실 비대기(5~8월) 적정 관수 필요",
      spacing: "덕 시설(지주·유인선) 설치, 주간 1.5~2m (10a당 약 150~250주). 덩굴성이라 유인 필수",
    ...
    tips: [
      "경북 문경이 전국 생산량의 절반 이상을 차지하는 대표 산지예요. 산지·준고랭지의 큰 일교차가 당도와 향을 높여요.",
      "덩굴성 작물이라 덕(지주·유인선) 시설이 필수예요. 초기 시설 투자가 수익성을 좌우해요.",
      "오미자청·오미자차·즙 등 가공품으로 6차산업 연계가 활발해요. 가공 시 부가가치가 크게 올라요.",
      "식재 후 3년차부터 결실하고, 산지·임야를 활용해 평지 농지 비용을 아낄 수 있어요.",
    ],
    relatedCropIds: ["bellflower", "ginseng", "blueberry"],
    prosCons: {
      pros: [
        { category: "확장성", text: "오미자청·차·즙 가공으로 부가가치를 크게 높일 수 있어요" },
        { category: "시장성", text: "한약재·건강음료 수요가 꾸준하고 문경 산지 브랜드가 강해요" },
        { category: "안정성", text: "산지·임야 활용으로 평지 농지 없이도 시작할 수 있어요" },
      ],
      cons: [
        { category: "수익성", text: "덕 시설 설치와 식재 후 3~4년 투자 기간이 필요해요" },
        { category: "재배난이도", text: "덩굴 유인·전정 관리와 수확 수작업에 손이 많이 가요" },
      ],
      verdict: "산간 정착형 임산물. 덕 시설과 가공 연계가 수익의 핵심이고, 문경권 준고랭지가 유리해요.",
    },
    cultivationSteps: [
      { step: 1, title: "식재", period: "3~4월 또는 11월", description: "1~2년생 묘목 식재. 덕 시설(지주·유인선) 설치. 산지 경사지 활용" },
      { step: 2, title: "유인·전정", period: "식재 후 1~3년", description: "덩굴을 유인선에 고정. 도장지 제거, 결과모지 배분. 3년차부터 결실 시작" },
      { step: 3, title: "착과·비대 관리", period: "5~8월", description: "개화 후 적정 관수. 탄저병·점무늬병 방제. 과실 비대기 인산·칼리 보강" },
      { step: 4, title: "수확·가공", period: "8~9월", description: "붉게 완숙한 송이를 수작업 수확. 생과 출하 또는 청·차·즙 가공 후 산지 직거래" },
    ],
    investmentDetail: {
      initialCost: "임야 1,000평당 약 1,500만~3,500만 원 (묘목·덕 시설·기반 조성)",
      annualOperatingCost: "약 500만~900만 원 (유인·전정·수확 인건비·자재)",
      breakEvenPeriod: "4~5년",
      minimumArea: "임야 1,000평 이상",
      annualLaborDays: "약 80~140일",
    },
  },
  {
    id: "chestnut",
    cultivation: {
      climate: "온난한 산지·구릉지 선호. 생육적온 16~25℃. 배수·통풍 좋은 남향 경사지 적합",
      soil: "배수 양호한 사질양토~양토, pH 5.0~6.0. 약산성 토양 선호",
      water: "성목은 건조에 비교적 강함. 결실기(7~8월) 가뭄 시 관수",
      spacing: "열간 8~10m, 주간 8~10m (10a당 약 15~25주). 수분수 혼식 권장",
    ...
    tips: [
      "충남 공주·부여와 경남이 대표 산지예요. 대표적인 단기소득 임산물이라 임업·산림 지원사업 혜택을 받을 수 있어요.",
      "한 번 조성하면 수십 년 수확하는 다년생이에요. 임야를 활용해 평지 농지 없이도 시작할 수 있어요.",
      "수확 후 저온저장·선별로 상품성을 높이고, 군밤·밤가공품으로 6차산업 연계가 가능해요.",
      "복숭아순나방·밤바구미 방제와 적기 수확이 품질을 좌우해요. 낙과 수거를 자주 해야 해요.",
    ],
    relatedCropIds: ["walnut", "shiitake", "persimmon"],
    prosCons: {
      pros: [
        { category: "안정성", text: "한 번 조성하면 수십 년 수확하고 임야 활용으로 토지 비용이 낮아요" },
        { category: "생활", text: "수확기 외에는 관리 부담이 적어 부업형 임업에 적합해요" },
        { category: "확장성", text: "임업·산림 지원사업 혜택과 군밤·가공 연계가 가능해요" },
      ],
      cons: [
        { category: "수익성", text: "조성 후 5~7년 본격 수확까지 투자 기간이 길어요" },
        { category: "시장성", text: "수입산 밤과의 가격 경쟁이 있어 국산·선별 차별화가 필요해요" },
      ],
      verdict: "임야 활용형 장기 임산물. 조성 기간을 견디면 수십 년 안정 수확이 가능하고 공주·부여권이 유리해요.",
    },
    cultivationSteps: [
      { step: 1, title: "조성·식재", period: "11~3월 (휴면기)", description: "산지 정지 후 1~2년생 묘목 식재. 수분수 혼식. 남향 경사지 활용" },
      { step: 2, title: "유목 관리", period: "식재 후 1~5년", description: "하예(下刈)·제초로 묘목 보호. 정지·전정으로 수형 잡기. 5년차부터 결실 시작" },
      { step: 3, title: "결실·방제", period: "5~8월", description: "개화 후 복숭아순나방·밤바구미 방제. 결실기 가뭄 시 관수. 하예 1~2회" },
      { step: 4, title: "수확·선별", period: "9~10월", description: "낙과·이구(果) 수거. 저온저장 후 크기·충실도 선별. 직거래·도매·군밤 가공 출하" },
    ],
    investmentDetail: {
      initialCost: "임야 1,000평당 약 1,500만~3,000만 원 (묘목·산지 조성·기본 장비)",
      annualOperatingCost: "약 400만~800만 원 (하예·전정·수확 인건비·방제비)",
      breakEvenPeriod: "5~7년",
      minimumArea: "임야 1,000평 이상",
      annualLaborDays: "약 60~100일",
    },
  },
  {
    id: "walnut",
    cultivation: {
      climate: "온난하고 일교차 큰 내륙 산지 선호. 생육적온 16~24℃. 개화기 늦서리 피해 주의",
      soil: "배수 양호한 사질양토~양토, pH 6.0~7.0. 토심 깊은 비옥한 토양 선호",
      water: "성목은 건조에 강함. 식재 초기·결실기 적정 관수",
      spacing: "열간 10~12m, 주간 10~12m (10a당 약 10~15주). 자가불화합성으로 수분수 혼식 필수",
    ...
    tips: [
      ...
      "자가불화합성이라 서로 다른 품종(수분수)을 반드시 섞어 심어야 결실이 잘돼요.",
      "한 번 조성하면 수십 년 수확하고, 수확기 외 관리 부담이 적어 부업·노후형 임업에 적합해요.",
    ],
    relatedCropIds: ["chestnut", "persimmon", "shiitake"],
    prosCons: {
      pros: [
        { category: "안정성", text: "한 번 조성하면 수십 년 수확하고 성목은 관리 부담이 적어요" },
        { category: "생활", text: "수확기 외 노동이 적어 부업·노후형 임업에 적합해요" },
        { category: "시장성", text: "국산 호두 수요가 꾸준해 수입산과 차별화가 가능해요" },
      ],
      cons: [
        { category: "수익성", text: "결실까지 7~10년으로 투자 회수 기간이 가장 긴 편이에요" },
        { category: "재배난이도", text: "자가불화합성이라 수분수 혼식이 필수고 늦서리 피해가 잦아요" },
      ],
      verdict: "초장기 투자형 임산물. 단기소득 작목과 병행 조성이 현실적이고, 김천·영동권 내륙 산지가 유리해요.",
    },
    cultivationSteps: [
      { step: 1, title: "조성·식재", period: "11~3월 (휴면기)", description: "산지 정지 후 1~2년생 접목묘 식재. 서로 다른 품종(수분수) 혼식 필수" },
      { step: 2, title: "유목 관리", period: "식재 후 1~7년", description: "하예·제초로 묘목 보호. 정지·전정으로 주간 형성. 7년차부터 본격 결실" },
      { step: 3, title: "결실·방제", period: "4~8월", description: "개화기 늦서리 방지. 검은무늬병·호두나방 방제. 결실기 적정 관수" },
      { step: 4, title: "수확·탈피", period: "9~10월", description: "낙과·청피 탈피 후 건조. 크기·충실도 선별. 직거래·도매·가공 출하" },
    ],
    investmentDetail: {
      initialCost: "임야 1,000평당 약 2,000만~4,000만 원 (접목묘·산지 조성·기본 장비)",
      annualOperatingCost: "약 400만~800만 원 (하예·전정·수확 인건비·방제비)",
      breakEvenPeriod: "7~10년",
      minimumArea: "임야 2,000평 이상",
      annualLaborDays: "약 50~80일",
    },
  },

  // 화훼 3종 detail — CROPS 화훼 블록과 1:1 매핑 (check-cross-reference F-1)
  // 소득: 장미만 농진청 2024 소득조사 등재. 국화·백합은 미등재로 명시하고 추정치 미기재
  {
    id: "rose",
    cultivation: {
      climate: "절화 품질은 온도가 좌우. 주간 24~27℃·야간 15~18℃ 유지. 연중 시설 환경 제어 필수",
      soil: "유기물 풍부한 사양토~양토, pH 5.5~6.5. 암면·코이어 수경재배 확산 중",
      water: "수경은 양액 자동 공급. 토경은 점적관수로 과습·건조 폭을 줄임",
      spacing: "절화용 10a당 재식본수 약 5,000~6,000주",
    ...
    relatedCropIds: ["chrysanthemum", "lily", "paprika"],
    prosCons: {
      pros: [
        { category: "수익성", text: "시설작목 4위 소득으로 화훼 중 소득 근거가 가장 뚜렷해요" },
        { category: "안정성", text: "연중 수확이라 현금 흐름이 매달 들어와요" },
        { category: "시장성", text: "절화 생산액 상위 품목으로 공판장 유통 경로가 안정적이에요" },
      ],
      cons: [
        { category: "수익성", text: "유리온실·수경 시설 투자와 겨울 난방비 부담이 커요" },
        { category: "재배난이도", text: "온도·양액이 조금만 어긋나도 화형·화색이 바로 떨어져요" },
        { category: "생활", text: "연중 채화라 쉬는 기간이 거의 없어요" },
      ],
      verdict: "화훼 중 소득 근거가 가장 뚜렷한 작목이에요. 시설 투자와 난방비를 감당할 본업 농가에 맞아요.",
    },
    cultivationSteps: [
      { step: 1, title: "시설·배지 준비", period: "정식 2~4주 전", description: "암면·코이어 배지 설치 또는 토양 소독. 양액 공급·난방·환기 계통 점검" },
      { step: 2, title: "정식", period: "작형에 따라 연중", description: "접목묘를 10a당 5,000~6,000주 정식. pH 5.5~6.5·주간 24~27℃·야간 15~18℃ 확보" },
      { step: 3, title: "유인·전정", period: "정식 후 6~10주~", description: "절곡(휘기)으로 광합성 잎 확보. 눈 솎기로 채화 주기 조절. 흰가루병·응애·총채벌레 방제" },
      { step: 4, title: "채화·선별·출하", period: "정식 후 3개월부터 연중", description: "봉오리가 벌어지기 직전 채화. 줄기 길이·화형 등급 선별 후 화훼공판장 경매 또는 직거래" },
    ],
    investmentDetail: {
      initialCost: "10a당 약 1억~2억 원 (유리온실·암면 수경·난방 설비)",
      annualOperatingCost: "10a당 약 2,000~3,500만 원 (난방·양액·인건비)",
      breakEvenPeriod: "5~8년 (시설 회수 기준)",
      minimumArea: "시설 1,000평 이상",
      annualLaborDays: "약 250~290일",
    },
  },
  {
    id: "chrysanthemum",
    cultivation: {
      climate: "생육적온 15~20℃. 동지아·지제부 눈은 -10℃에도 견뎌 월동 가능. 개화기에는 최저 18℃ 확보",
      soil: "배수 양호한 사질양토~양토, pH 5.5~6.5. 연작 시 토양 소독 필요",
      water: "정식 초기 충분한 관수. 화색 발현기 과습은 잿빛곰팡이병 위험",
      spacing: "무적심 재배 시 10a당 약 35,000~40,000주",
      fertilizerNote: "생육 전반 2/3까지 질소 위주, 후반 1/3은 질소를 줄여 N:K 비율을 1:2로 맞춤",
    },
    income: {
      revenueRange: "공식 소득통계 미등재 (농촌진흥청 소득조사 작목 미포함)",
      costNote: "전조등·차광 암막 등 일장 조절 설비가 필수. 노지 추국은 투자가 낮은 대신 출하기가 겹침",
      laborNote: "정식·적심·적아·채화에 노동 집중. 작형을 나누면 연중 분산 가능",
      minScale: "시설 500평 이상 (노지 추국은 1,000평 이상)",
      annualWorkdays: "약 180~240일 (작형 수에 따라 변동)",
      laborIntensity: "높음",
      source: "농사로 국화 재배력(농촌진흥청) / 충청북도 농업기술원 화훼 영농기술 / 농림축산식품부 화훼재배현황",
      varieties: [
        { name: "스탠다드 (대륜 1송이)", note: "주산지 경남 창원·김해, 부산. 제례·경조사 수요 중심" },
        { name: "스프레이 (분지 다화)", note: "주산지 충남 태안·예산. 꽃다발·꽃바구니 수요 증가" },
      ],
    },
    majorRegions: ["경상남도", "부산광역시", "충청남도", "전라남도"],
    tips: [
      "스탠다드는 경남 창원·김해와 부산, 스프레이는 충남 태안·예산이 주산지예요(농사로 국화 재배력).",
      "전조재배는 12~1월, 차광재배는 8~9월, 노지재배는 10~11월 개화예요. 작형을 섞으면 출하가 연중 분산돼요.",
      "전조는 10~13㎡당 100W 조명을 식물 위 90cm에 달고 심야 4시간 비춰요. 차광은 오후 6시~오전 7시 암막으로 일장을 12~13시간에 맞춰요.",
      "10a당 소득이 농촌진흥청 소득조사 작목에 안 들어가요. 지역 농업기술원 경영 사례와 화훼공판장 경락가로 직접 따져 보세요.",
    ],
    relatedCropIds: ["rose", "lily", "paprika"],
    prosCons: {
      pros: [
        { category: "시장성", text: "절화 판매량 비중이 가장 큰 품목으로 수요 기반이 두터워요" },
        { category: "확장성", text: "전조·차광으로 개화를 옮겨 성수기 출하를 노릴 수 있어요" },
        { category: "재배난이도", text: "내한성이 강해 노지 추국으로 낮은 투자부터 시작할 수 있어요" },
      ],
      cons: [
        { category: "수익성", text: "공식 10a당 소득 통계가 없어 수익 예측이 불확실해요" },
        { category: "재배난이도", text: "일장 조절을 놓치면 개화기가 어긋나 성수기를 놓쳐요" },
        { category: "안정성", text: "제례·경조사 수요 의존도가 높아 소비 흐름 변화에 민감해요" },
      ],
      verdict: "일장 조절 기술이 소득을 가르는 작목이에요. 노지 추국으로 시작해 전조·차광 시설로 넓히는 순서가 현실적이에요.",
    },
    cultivationSteps: [
      { step: 1, title: "삽목·육묘", period: "작형별 정식 4~5주 전", description: "모주에서 삽수 채취 후 삽목. 발근까지 15~20일. 바이러스·바이로이드 무병주 확보가 중요" },
      { step: 2, title: "정식", period: "전조: 8~9월 / 차광: 5~6월 / 노지: 5~6월", description: "무적심 재배 시 10a당 35,000~40,000주. pH 5.5~6.5·생육적온 15~20℃ 확보" },
      { step: 3, title: "일장 처리", period: "정식 후 3~6주", description: "전조는 심야 4시간 조명으로 화아분화 억제, 차광은 암막으로 12~13시간 단일 처리. 흰가루병·시들음병·총채벌레 방제" },
      { step: 4, title: "채화·선별·출하", period: "전조: 12~1월 / 차광: 8~9월 / 노지: 10~11월", description: "꽃잎이 3/4 벌어졌을 때 채화. 줄기 길이·화형 선별 후 공판장 경매 또는 직거래" },
    ],
    investmentDetail: {
      initialCost: "시설 10a당 약 3,000~6,000만 원 (비닐하우스·전조등·차광 암막) / 노지는 약 300~600만 원",
      annualOperatingCost: "10a당 약 800~1,800만 원 (삽수·전력·인건비)",
      breakEvenPeriod: "3~5년 (시설 기준) / 노지는 1~2년",
      minimumArea: "시설 500평 이상",
      annualLaborDays: "약 180~240일",
    },
  },
  {
    id: "lily",
    cultivation: {
      climate: "발아 25℃, 잎·줄기 생장 15~25℃, 꽃봉오리 발육기 야간 15℃ 이상. 촉성재배는 겨울 주간 15℃·야간 13℃ 이상 확보",
      soil: "배수 양호한 사질양토, pH 5.5~6.5. 구근부패병 방지를 위해 과습 회피",
      water: "정식 후 2~3주는 70% 이상 차광으로 지온을 낮추며 관수. 이후 점적관수로 균일 공급",
      spacing: "3.3㎡당 약 80구 (10a당 약 24,000구). 오리엔탈은 고온 피해를 줄이려 10cm 이상 깊이 정식",
      fertilizerNote: "10a당 퇴비 1,500kg·질소 10kg·인산 10kg·칼륨 10kg 전량 밑거름 (오리엔탈나리 촉성재배 기준)",
    },
    income: {
      revenueRange: "공식 소득통계 미등재 (농촌진흥청 소득조사 작목 미포함)",
      costNote: "절화용 구근은 한 번 쓰고 재사용하지 않아 매 작기 구근 구입비가 고정 발생. 국내 유통 구근은 네덜란드산 비중이 높음",
      laborNote: "정식·차광·채화에 노동 집중. 작형을 나누면 연중 분산 가능",
      minScale: "시설 500평 이상",
      annualWorkdays: "약 150~200일",
      laborIntensity: "보통",
      source: "농사로 오리엔탈나리(촉성재배) 재배력(농촌진흥청) / 충청북도 농업기술원 화훼 영농기술 / 농림축산식품부 화훼재배현황",
      varieties: [
        { name: "오리엔탈 계통", note: "향이 있고 절화 수명이 아시아틱보다 한 달가량 길다. 정식~개화 80~130일" },
        { name: "아시아틱 계통", note: "상향 개화, 향 없음. 촉성·억제 재배가 비교적 쉬움" },
        { name: "나팔나리 계통", note: "고랭지 실생재배로 7~11월 단경기 수요 대응" },
      ],
    },
    majorRegions: ["강원도", "제주특별자치도", "충청남도"],
    tips: [
      "강원은 여름, 제주는 겨울, 충남은 봄·가을에 출하가 몰려요. 우리 지역 출하 시기를 먼저 확인하세요.",
      "구근은 2~5℃에서 8~10주 저온처리가 필요해요. 촉성재배는 싹을 5cm 정도 틔워서 아주심기해요.",
      "구근 구입비가 고정비라 구근 단가와 환율이 수익을 크게 좌우해요. 강릉 등 국산 종구 물량도 함께 견적 받아 보세요.",
      "정식 후 2~3주는 70% 이상 차광으로 지온을 낮춰야 뿌리가 잘 내려요. 잎마름병·구근부패병·진딧물이 주요 병해충이에요.",
    ],
    relatedCropIds: ["rose", "chrysanthemum", "paprika"],
    prosCons: {
      pros: [
        { category: "수익성", text: "정식 후 4~6개월이면 절화를 내 회전이 빠른 편이에요" },
        { category: "확장성", text: "지역별 출하 시기가 달라 비수기를 노린 작형 설계가 가능해요" },
        { category: "재배난이도", text: "구근에 양분이 들어 있어 생육 관리 폭이 장미보다 넓어요" },
      ],
      cons: [
        { category: "수익성", text: "공식 10a당 소득 통계가 없고 구근 구입비가 매 작기 고정으로 들어요" },
        { category: "안정성", text: "구근을 수입에 크게 의존해 환율·수급에 흔들려요" },
        { category: "재배난이도", text: "지온이 높으면 구근부패병·꽃눈 퇴화가 생겨 차광 관리가 까다로워요" },
      ],
      verdict: "구근 구입비가 손익을 가르는 작목이에요. 출하 비수기를 노린 작형 설계와 구근 조달 경로 확보가 먼저예요.",
    },
    cultivationSteps: [
      { step: 1, title: "구근 저온처리", period: "정식 6~10주 전", description: "2~5℃에서 8~10주 저온처리. 촉성재배는 싹을 5cm 정도 틔워 아주심기 준비" },
      { step: 2, title: "정식", period: "촉성: 9월 상순~11월 상순", description: "3.3㎡당 약 80구, 오리엔탈은 10cm 이상 깊이. 퇴비 1,500kg·N·P·K 각 10kg 전량 밑거름" },
      { step: 3, title: "차광·생육 관리", period: "정식 후 2~3주 / 이후 개화기까지", description: "70% 이상 차광으로 지온 억제. 잎·줄기 생장 15~25℃, 꽃봉오리기 야간 15℃ 이상. 잎마름병·구근부패병·진딧물 방제" },
      { step: 4, title: "채화·선별·출하", period: "촉성: 3월 상순~4월 하순 (4월 중순 성출하)", description: "첫 봉오리에 색이 오를 때 채화. 봉오리 수·줄기 길이 선별 후 공판장 경매 또는 수출 출하" },
    ],
    investmentDetail: {
      initialCost: "시설 10a당 약 3,000~6,000만 원 (비닐하우스·차광 설비·관수)",
      annualOperatingCost: "10a당 약 1,500~3,000만 원 (구근 구입비 비중이 가장 큼)",
      breakEvenPeriod: "3~5년 (시설 회수 기준)",
      minimumArea: "시설 500평 이상",
      annualLaborDays: "약 150~200일",
    },
  },
