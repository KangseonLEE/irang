...
export const GOV_PROGRAMS: GovProgramRoadmap[] = [
     ...
     ═══════════════════════════════════════════ */
  {
    ...
    icon: Monitor,
    summary:
      "ICT 기술(센서, 자동제어, 데이터 분석)을 활용한 온실·축사 등 스마트 농업 창업을 지원합니다. 청년창업보육센터(20개월 무료 과정), 시설 설치비 보조(30~50%), 혁신밸리 입주 등 단계별 지원이 제공됩니다.",
    ...
    steps: [
      {
        ...
        title: "스마트팜 교육 이수",
        description:
          "농업기술센터, 스마트팜코리아 포털(smartfarmkorea.net) 등에서 스마트팜 기초·심화 교육을 이수합니다. 청년(만 18~39세)은 청년창업보육센터 20개월 과정에 지원할 수 있습니다.",
      ...
      },
      {
        ...
        title: "창업 계획 수립",
        description:
          "재배 작물, 온실 규모, ICT 설비 구성, 투자 계획 등을 포함한 스마트팜 창업 계획서를 작성합니다.",
        duration: "1~2개월",
        tips: [
          "데이터 기반 생산 관리 계획을 구체적으로 작성하세요",
          "에너지 절감, 생산성 향상 목표를 수치로 제시하면 유리",
          "혁신밸리 입주를 병행하면 멘토링과 시설 지원이 추가됩니다",
        ],
      },
      {
        order: 3,
        title: "지원사업 신청",
        description:
          "스마트팜코리아(smartfarmkorea.net) 또는 관할 시·군·구 농업 부서에 사업 계획서와 서류를 제출합니다.",
        duration: "공고 후 2~4주",
        documents: [
          "사업 신청서 (소정 양식)",
          "스마트팜 도입 사업 계획서",
      ...
      },
      {
        ...
        title: "심사 및 선정",
        description:
          "서류 심사와 현장 확인을 거쳐 최종 선정됩니다. ICT 도입 계획의 구체성, 생산성 향상 기대치, 사후 관리 역량이 핵심 평가 항목입니다.",
        duration: "1~2개월",
        tips: [
          "데이터 활용 계획(센서 모니터링, 자동 제어)이 구체적일수록 유리",
          "기존 영농 경험 + ICT 결합 계획이 높은 점수를 받습니다",
        ],
      },
      {
        order: 5,
        title: "시설 설치 및 운영",
        description:
          "선정 후 보조금·융자금이 지급되어 ICT 설비를 설치합니다. 설치 완료 후 정기 점검과 성과 보고 의무가 있습니다.",
        duration: "설치 3~6개월, 운영 지속",
        tips: [
          "설비 설치는 정부 인증 업체를 통해야 보조금이 지급됩니다",
          "설치 후 최소 5년간 목적 외 사용·매각 불가",
          "데이터 수집·분석 결과를 농업기술센터와 공유해야 합니다",
        ],
      },
    ],
    requiredDocuments: [
    ...
    caution:
      "스마트팜 시설비 보조율(30~50%)은 품목·시설 유형·지자체별로 상이하며, 매년 예산에 따라 변동됩니다. 정확한 보조율은 반드시 해당 연도 공고문을 확인하세요. ICT 설비는 정부 인증 업체를 통해 설치해야 보조금이 지급되며, 비인증 업체 설비는 지원 대상에서 제외됩니다.",
    relatedLinks: [
      { label: "지원사업 검색", href: "/programs" },
      { label: "작물 정보", href: "/crops" },
      {
