...
export const GOV_PROGRAMS: GovProgramRoadmap[] = [
     ...
     ═══════════════════════════════════════════ */
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "선택한 농촌 지역으로 전입신고를 하고, 농업경영정보시스템(AGRIX)에 농업경영체 등록을 합��다.",
        duration: "1~2주",
        documents: [
          "전입신고서",
          "농업경영체 등록 신청서",
     ...
     ═══════════════════════════════════════════ */
  {
    ...
    supportAmount: "농지 임대료 시세 대비 70~90% 수��",
    eligibility: [
      {
        label: "농업인 자격",
     ...
     ═══════════════════���═══════════════════════ */
  {
    ...
    steps: [
      ...
      },
      {
        ...
        title: "심사 및 선정",
        description:
          "서류 심사와 현장 확인을 거쳐 최종 ���정됩니다. 창업 아이템의 독창성, 지역 경제 기여도, 실현 가능성이 핵심 평가 항목입니다.",
        duration: "1~2개월",
        tips: [
