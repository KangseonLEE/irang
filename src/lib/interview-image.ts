 ...
 * 2026-05-15: D2 외부 큐레이션 7명 추가 (병렬 codex-image).
 * 2026-05-18: D6+ mountain·healing 5명 추가 (병렬 codex-image 5장 → cwebp 변환).
...
const ILLUSTRATED_PERSONS = new Set<string>([
  ...
  "park-jaeyoung",
  "jung-changgyun",
  // 2026-05-18 D6+ mountain·healing 5명
  "lee-chunbok",
  "kim-youngsook",
  "oh-geumok",
  "so-hyangmi",
