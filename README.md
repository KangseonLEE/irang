...
### Phase 1 — 정보 큐레이션 MVP ✅ (2026-04)

- **지역 탐색** `/regions` — 시·도 → 시·군·구 → 읍·면 드릴다운, 비교·랭킹(`/regions/ranking`)
- **지원사업 검색** `/programs` — 나이/지역/희망 작물 조건 필터 + 로드맵
- **작물 정보** `/crops` — 재배 환경, 수익성, 난이도, 비교

### Phase 2 — 진단 v2.0 + SEO 발견성 ✅ (2026-04 ~ 2026-08)

- **귀농 진단** `/assess` — 유형 분류·공유 링크(`/assess/r/[data]`)·결과 저장
- **SEO** — JSON-LD 구조화 데이터, sitemap, 소프트 404 정리, OG 이미지
- **신뢰** — 면책 고지(`/about/disclaimer`), 정정 이력(`/about/corrections`), 업데이트 소식(`/about/updates`)
- **콘텐츠** — 인터뷰(`/interviews`), 가이드 5종(`/guides`), 용어집, 비용 계산(`/costs`)

### Phase 3 — 커뮤니티 & 콘텐츠 🔄 (2026-09 ~)

- ✅ 1단계 '한 줄 의견' — 사전 승인제 + 룰 기반 스팸 필터 + admin 승인 큐 (2026-09-02)
- ⏳ 2단계 Q&A / 후기 — 1단계 참여 지표 확인 후 판단

### Phase 4 — 스마트팜 연계 (미정)

- 스마트팜 장비/솔루션 연계, 재배 관리 대시보드
...
| 마일스톤 | 내용 | 목표 시점 |
|---------|------|----------|
| M0 | 시장조사 + PRD 확정 | 2026-04 ✅ |
| M1 | 데이터 소스 확보 + 스키마 설계 | 2026-04 ✅ |
| M2 | MVP 개발 + 배포 (irangfarm.com) | 2026-04 ✅ |
| M3 | 진단 v2.0 + SEO + 신뢰 장치 | 2026-08 ✅ |
| M4 | 커뮤니티 1단계 출시 | 2026-09-02 ✅ |
| M5 | 유입·참여 지표 기반 Go/No-Go (커뮤니티 2단계) | 2026-10 ⏳ |
