 ...
 * - SP-046 ↔ SP-047: 안동시 **주택수리비(보일러·지붕 등 수리, 9가구·500만·보조 50%, 3/12~10/30)** ↔
 *   **농가주택 신축 설계비(5가구·75만·보조 100%, 1월~11/30)**. 같은 영농지원과·같은 게시판(title 40%)이지만
 *   사업 내용·사업량·보조율·접수기간 4종 상이, 별도 시행지침·별도 공고(1/12·3/11).
 * - SP-048 ↔ SP-049: 진안군 **「고향에서 살아보기」(진안 밖 출향민, 2주 체험, 5가구·1인 5만, ~9/6)** ↔
 *   **「슬기로운 진안생활」(전입 5년 이내 군민, 정책·상담 교육 6회, 회차 10명·무료, 8/28~선착순)**.
 *   대상자가 상호 배타적(밖↔안)이고 내용·비용·기간 전부 다름(title 33%, org✓+url✓ 승격 케이스).
 * - SP-050 ↔ SP-051: 농지은행 **「과원매매사업」(과수원 구입 융자, ㎡당 2만 원·연 2%·11~30년 상환, 신규과원
 *   조성계획서)** ↔ **「과원임대차사업」(과수원 5~10년 장기 임차 중개, 임차료 지역 관행 상한 내 협의, 과원장기
 *   임차신청서)**. 같은 「과원규모화사업」 우산 아래 매매/임대차 별개 트랙 — supportType(융자/현물)·지원조건·
 *   신청서류·원문 페이지(menuId 0500100030/0500100040)가 전부 다름. 같은 기관·같은 도메인이라 org✓+url✓ 승격.
 * - SP-054 ↔ SP-060: 농식품부 **「스마트팜 ICT융복합확산」의 세부사업 2종** — 시설원예 현대화(관수·환경관리·
 *   작업 설비, 정부24 SD0000010098) ↔ 에너지절감시설(다겹보온커튼·수막재배·열회수, 154300005010). 같은 모사업
 *   이라 제목 앞부분이 같지만 지원 품목·대상(후자는 버섯류 포함)·원문 페이지가 다름.
 *
